...
/**
 * Interface for variables that represent the values of ints computed during the execution of the model.
 */
public interface ComputedInteger extends ComputedVariable {
