...
public abstract class ComputedIntegerInternal extends ComputedVariableInternal implements ComputedInteger {
    private int[] samples;
    private int map;

    public ComputedIntegerInternal(Model model, String name, boolean isSettable, boolean isSample, boolean isPrivate) {
