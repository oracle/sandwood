...
/**
 * Interface to be implemented by objects that represent observed arrays of booleans in a model.
 */

public interface ObservedBooleanArray extends ObservedVariable {
