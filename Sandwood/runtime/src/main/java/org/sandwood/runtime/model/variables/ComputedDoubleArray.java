...
/**
 * Interface for variables that represent the values of arrays of double's computed during the execution of the model.
 */
public interface ComputedDoubleArray extends ComputedVariable {
