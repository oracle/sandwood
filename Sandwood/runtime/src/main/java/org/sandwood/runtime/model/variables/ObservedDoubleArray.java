...
/**
 * Interface to be implemented by objects that represent observed arrays of doubles in a model.
 */

public interface ObservedDoubleArray extends ObservedVariable {
