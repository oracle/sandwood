...
/**
 * Interface for variables that represent the values of arrays of boolean's computed during the execution of the model.
 */
public interface ComputedBooleanArray extends ComputedVariable {
