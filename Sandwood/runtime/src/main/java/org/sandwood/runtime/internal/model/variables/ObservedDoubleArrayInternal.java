...
public abstract class ObservedDoubleArrayInternal extends ObservedVariableInternalBase implements ObservedDoubleArray {

    public ObservedDoubleArrayInternal(Model model, String name) {
        super(model, name);
    }
