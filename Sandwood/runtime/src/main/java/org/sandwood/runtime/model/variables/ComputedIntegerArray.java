...
/**
 * Interface for variables that represent the values of arrays of ints computed during the execution of the model.
 */
public interface ComputedIntegerArray extends ComputedVariable {
