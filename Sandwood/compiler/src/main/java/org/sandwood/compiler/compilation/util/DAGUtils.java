...
public class DAGUtils {
    ...
    /**
     * Method to check if all the tasks in a set can be skipped. This will test if the individual tasks are skippable,
     ...
     */
    public static boolean skippable(Collection<DataflowTask<?>> tasks) {
