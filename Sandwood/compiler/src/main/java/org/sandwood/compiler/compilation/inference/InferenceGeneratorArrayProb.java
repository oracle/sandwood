 ...
 * @param <B>
 */
public abstract class InferenceGeneratorArrayProb<A extends Variable<A>, B extends RandomVariable<ArrayVariable<A>, B>, FuncData extends InferenceGeneratorArrayProb.ArrayProbFunctionData<A, B>>
        extends InferenceGeneratorArray<A, B, FuncData> {

    public abstract static class ArrayProbFunctionData<A extends Variable<A>, B extends RandomVariable<ArrayVariable<A>, B>>
            extends ArrayFunctionData<A, B> {

        final IntVariable noStates;

        public final IRTreeReturn<IntVariable> valuePos = load(valuePosName);

        public List<IRTreeReturn<?>> consumerRVArgs;

        protected ArrayProbFunctionData(SampleTask<ArrayVariable<A>, B> sample, IntVariable noStates,
