...
public class IntVariable extends NumberVariable<IntVariable> {
    ...
    @Override
    public IntVariable copy() {
        return intVariable(new CopyNumberTask<>(this));
    }

    @Override
    public IntVariable copy(Location location) {
        return intVariable(new CopyNumberTask<>(this, location));
    }
