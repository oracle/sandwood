...
public class HMMTestPart5 extends GeneratedAPIBuilder {
    @Override
    public CompilationDesc buildClass(CompilationOptions opts) {
        ...
        parFor(intVariable(1, location(26, 20, 26, 20)), samples, intVariable(1, location(26, 19, 26, 22)), true, location(26, 9, 26, 31), (i) -> { 
            ...
            st.put(i, states.times(categorical(m.get(st.get(i.subtract(intVariable(1, location(27, 49, 27, 49)), location(27, 48, 27, 48)), location(27, 46, 27, 50)), location(27, 43, 27, 51)), location(27, 30, 27, 52)).sample(location(27, 54, 27, 61)), location(27, 28, 27, 28)), location(27, 15, 27, 28));
        });
        ...
        return compileAPI(opts, $variableNames, "HMMTestPart5", $helperClasses, "org.sandwood.compiler.tests.parser", $constructorArgs, getOriginalModel(), null);
    }
