																	...
																	if((i$var119 == index$i$4_7)) {
																		if(((0 <= j) && (j < time_dim))) {
																			if((0 < time_dim)) {
																				...
																				for(int cv$reduction681Index = 0; cv$reduction681Index < j; cv$reduction681Index += 1) {
																					// Set the left hand term of the reduction function to the return variable value.
																					double x = reduceVar$var151$10;
																					
																					// Set the right hand term to a value from the array var141
																					double y = time_impact[index$t$4_6][index$i$4_7][cv$reduction681Index];
																				...
																				for(int cv$reduction681Index = (j + 1); cv$reduction681Index < time_dim; cv$reduction681Index += 1) {
																					// Set the left hand term of the reduction function to the return variable value.
																					double x = reduceVar$var151$10;
