...
public final class Conditional2c extends Model {
    ...
    @Override
    protected Conditional2c$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        Conditional2c$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new Conditional2c$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new Conditional2c$MultiThreadCPU(target);
                break;
            default:
