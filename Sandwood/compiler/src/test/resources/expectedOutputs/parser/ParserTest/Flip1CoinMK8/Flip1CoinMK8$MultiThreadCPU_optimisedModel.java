...
class Flip1CoinMK8$MultiThreadCPU extends org.sandwood.runtime.internal.model.CoreModelMultiThreadCPU implements Flip1CoinMK8$CoreInterface {
	...
	public Flip1CoinMK8$MultiThreadCPU(ExecutionTarget target) {
		super(target);
	}
