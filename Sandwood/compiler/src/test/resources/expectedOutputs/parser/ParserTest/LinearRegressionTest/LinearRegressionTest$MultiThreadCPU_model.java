																	...
																	{
																		{
																			...
																			if((0 < state.k)) {
																				...
																				for(int cv$reduction436Index = 0; cv$reduction436Index < j$var55; cv$reduction436Index += 1) {
																					// Set the left hand term of the reduction function to the return variable value.
																					double i$var67 = reduceVar$var70$6;
																					
																					// Set the right hand term to a value from the array phi
																					double j$var68 = state.phi[((i$var45 - 0) / 1)][cv$reduction436Index];
																				...
																				for(int cv$reduction436Index = (j$var55 + 1); cv$reduction436Index < state.k; cv$reduction436Index += 1) {
																					// Set the left hand term of the reduction function to the return variable value.
																					double i$var67 = reduceVar$var70$6;
