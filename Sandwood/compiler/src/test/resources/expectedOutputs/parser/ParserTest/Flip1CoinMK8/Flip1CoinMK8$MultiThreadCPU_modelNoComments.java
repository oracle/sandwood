...
import org.sandwood.compiler.tests.parser.Flip1CoinMK8$MultiThreadCPU.Scratch;
...
final class Flip1CoinMK8$MultiThreadCPU extends CoreModelMultiThreadCPU<State, Scratch> {
	...
	public Flip1CoinMK8$MultiThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
