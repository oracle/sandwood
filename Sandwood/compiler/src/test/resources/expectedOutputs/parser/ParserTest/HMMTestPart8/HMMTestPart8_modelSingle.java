...
/**
 * Class representing the Sandwood model HMMTestPart8 This is the class that all user
 * interactions with the model should occur through.
 */
public final class HMMTestPart8 extends Model<HMMTestPart8.State> {
    ...
    public HMMTestPart8() {
        ...
        HMMTestPart8$SingleThreadCPU core = new HMMTestPart8$SingleThreadCPU(state, ExecutionTarget.singleThread);
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new HMMTestPart8$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new HMMTestPart8$MultiThreadCPU(state, target);
            default:
