...
/**
 * Class representing the Sandwood model HMMTestPart2 This is the class that all user
 * interactions with the model should occur through.
 */
public final class HMMTestPart2 extends Model<HMMTestPart2.State> {
...
double[] bias;
		...
		final boolean get$fixedFlag$sample69() {
			return fixedFlag$sample69;
		}

		final void set$fixedFlag$sample69(boolean cv$value, boolean allocated$) {
    ...
    private final ComputedIntegerArrayInternal $st = new ComputedIntegerArrayInternal(this, "st", true, true, false, ProbabilityType.UNSKIPPABLE) {
        ...
        public void setFixed(boolean fixed) {
            synchronized(model) {
                state.set$fixedFlag$sample69(fixed, allocated);
            }
        }

        @Override
        public Immutability isFixed() {
            if(state.get$fixedFlag$sample69())
                return Immutability.FIXED;
            else
                return Immutability.FREE;
        }
    ...
    public HMMTestPart2() {
        ...
        HMMTestPart2$SingleThreadCPU core = new HMMTestPart2$SingleThreadCPU(state, ExecutionTarget.singleThread);
	 ...
	 */
    public HMMTestPart2(int flipsMeasuredShape) {
        this();
	 ...
	 */
    public HMMTestPart2(boolean[] flipsMeasured) {
        this();
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new HMMTestPart2$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new HMMTestPart2$MultiThreadCPU(state, target);
            default:
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(HMMTestPart2 system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(HMMTestPart2 system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(HMMTestPart2 system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(HMMTestPart2 system$model) {
