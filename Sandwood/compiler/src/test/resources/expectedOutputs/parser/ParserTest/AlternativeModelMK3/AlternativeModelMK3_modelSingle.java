...
/**
  ...
  */
public class AlternativeModelMK3 extends Model {
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(AlternativeModelMK3 system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(AlternativeModelMK3 system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(AlternativeModelMK3 system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(AlternativeModelMK3 system$model) {
