...
public class Flip1CoinMK8 extends GeneratedAPIBuilder {
    @Override
    public CompilationDesc buildClass(CompilationOptions opts) {
        ...
        parFor(intVariable(0, location(19, 16, 19, 16)), samples, intVariable(1, location(19, 15, 19, 18)), true, location(19, 5, 19, 27), (i) -> { 
            ...
            (flips.get(i, location(20, 16, 20, 18)).negate(location(20, 10, 20, 10))).observe(flipsMeasured.get(i, location(20, 42, 20, 44)), location(20, 21, 20, 45));
        });
        ...
        return compileAPI(opts, $variableNames, "Flip1CoinMK8", $helperClasses, "org.sandwood.compiler.tests.parser", $constructorArgs, getOriginalModel(), null);
    }
