...
/**
  * Class representing the Sandwood model Flip2CoinsMK6 This is the class that
  * all user interactions with the model should occur through.
  */
public final class Flip2CoinsMK6 extends Model {

    private Flip2CoinsMK6$CoreInterface system$c = new Flip2CoinsMK6$SingleThreadCPU(ExecutionTarget.singleThread);
    ...
    private final RandomVariableInternal $beta = new RandomVariableInternal(this, "beta", ProbabilityType.SKIPPABLE) {
        @Override
        public double getCurrentLogProbability() {
    ...
    @Override
    protected Flip2CoinsMK6$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        Flip2CoinsMK6$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new Flip2CoinsMK6$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new Flip2CoinsMK6$MultiThreadCPU(target);
                break;
            default:
