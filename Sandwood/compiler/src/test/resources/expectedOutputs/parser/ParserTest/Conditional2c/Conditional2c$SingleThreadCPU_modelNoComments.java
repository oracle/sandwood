...
import org.sandwood.compiler.tests.parser.Conditional2c$SingleThreadCPU.Scratch;
import org.sandwood.compiler.tests.parser.Conditional2c.State;
import org.sandwood.runtime.internal.model.CoreModelSingleThreadCPU;
import org.sandwood.runtime.internal.model.state.CoreModelScratch;
import org.sandwood.runtime.internal.numericTools.DistributionSampling;
import org.sandwood.runtime.model.ExecutionTarget;

final class Conditional2c$SingleThreadCPU extends CoreModelSingleThreadCPU<State, Scratch> {
...
double[] cv$var4$stateProbabilityGlobal;
	...
	public Conditional2c$SingleThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
	...
	private final void logProbabilityValue$sample10() {
		if(!state.fixedProbFlag$sample10) {
			...
			state.logProbability$u = cv$sampleProbability;
			...
			double cv$sampleValue = state.logProbability$u;
