...
public class HMMTestPart3 extends GeneratedAPIBuilder {
    @Override
    public CompilationDesc buildClass(CompilationOptions opts) {
        ...
        parFor(intVariable(1, location(26, 20, 26, 20)), samples, intVariable(1, location(26, 19, 26, 22)), true, location(26, 9, 26, 31), (i) -> { 
            ...
            st.put(i, categorical(m.get(st.get(i.subtract(intVariable(1, location(27, 40, 27, 40)), location(27, 39, 27, 39)), location(27, 37, 27, 41)), location(27, 34, 27, 42)), location(27, 21, 27, 43)).sample(location(27, 45, 27, 52)), location(27, 15, 27, 52));
        });
        ...
        return compileAPI(opts, $variableNames, "HMMTestPart3", $helperClasses, "org.sandwood.compiler.tests.parser", $constructorArgs, getOriginalModel(), null);
    }
