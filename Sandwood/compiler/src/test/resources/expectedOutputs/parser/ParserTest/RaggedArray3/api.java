...
public class RaggedArray3 extends GeneratedAPIBuilder {
    @Override
    public CompilationDesc buildClass(CompilationOptions opts) {
        //Allocating initial observed parameters
        IntVariable y = observeInt("y", location(11, 27, 11, 31));
        ArrayVariable<IntVariable> obs_measured = observeArray("obs_measured", VariableType.arrayType(VariableType.IntVariable), location(11, 34, 11, 51));
        ...
        ArrayVariable<IntVariable> obs = categorical(d, location(15, 17, 15, 30)).sample(obs_measured.length(location(15, 52, 15, 57)), location(15, 32, 15, 58));
        obs.setAlias("obs");
        obs.setLocation(location(15, 11, 15, 13));
