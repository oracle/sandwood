...
import org.sandwood.compiler.tests.parser.Conditional1b$SingleThreadCPU.Scratch;
...
final class Conditional1b$SingleThreadCPU extends CoreModelSingleThreadCPU<State, Scratch> {
...
double[] cv$var4$stateProbabilityGlobal;
	...
	public Conditional1b$SingleThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
