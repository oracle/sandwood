...
interface HMMMetrics4$CoreInterface extends org.sandwood.runtime.internal.model.CoreModel {
	...
	public void set$current_metric_valid_bias(double[][] cv$value, boolean allocated$);

	// Getter for current_metric_var.
	public double[][] get$current_metric_var();

	// Setter for current_metric_var.
	public void set$current_metric_var(double[][] cv$value, boolean allocated$);
	...
	public void set$fixedFlag$sample33(boolean cv$value, boolean allocated$);
	...
	public void set$max_metric(int cv$value, boolean allocated$);
