...
public class RaggedArray6 extends Model {
    ...
    @Override
    protected RaggedArray6$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        RaggedArray6$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new RaggedArray6$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new RaggedArray6$MultiThreadCPU(target);
                break;
            default:
    ...
    private void transferData(RaggedArray6$CoreInterface oldCore, RaggedArray6$CoreInterface newCore) {
