...
public class DistributionTest5 extends Model {
    ...
    @Override
    protected DistributionTest5$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        DistributionTest5$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new DistributionTest5$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new DistributionTest5$MultiThreadCPU(target);
                break;
            default:
