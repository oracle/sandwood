	...
	private final void logProbabilityValue$sample51() {
		...
		if(!fixedProbFlag$sample51) {
			...
			for(int t$var46 = 0; t$var46 < T; t$var46 += 1)
				...
				// 
				// The sample value to calculate the probability of generating
				cv$sampleAccumulator = (cv$sampleAccumulator + DistributionSampling.logProbabilityPoisson(arrivals[t$var46], lambda[t$var46]));
		...
		// Using cached values.
			...
			// 
			// Variable declaration of cv$accumulator moved.
			logProbability$arrivals = (logProbability$arrivals + logProbability$var49);
