...
/**
  * Class representing the Sandwood model HMMTestPart3 This is the class that
  * all user interactions with the model should occur through.
  */
public class HMMTestPart3 extends Model {

    private HMMTestPart3$CoreInterface system$c = new HMMTestPart3$SingleThreadCPU(ExecutionTarget.singleThread);
    ...
    private final ComputedBooleanArrayInternal $flips = new ComputedBooleanArrayInternal(this, "flips", true) {
        ...
        @Override
        public Immutability isFixed() {
            if(system$c.get$fixedFlag$sample91())
                return Immutability.FIXED;
            else
                return Immutability.FREE;
        }
    ...
    private final ComputedIntegerArrayInternal $st = new ComputedIntegerArrayInternal(this, "st", true) {
        ...
        public Immutability isFixed() {
            ...
            boolean fixedFlag$sample75 = system$c.get$fixedFlag$sample75();
            if(fixedFlag$sample57 && fixedFlag$sample75)
                return Immutability.FIXED;
            else if(fixedFlag$sample57 || fixedFlag$sample75)
    ...
    public HMMTestPart3(int flipsMeasuredShape) {
        this();
    ...
    public HMMTestPart3(boolean[] flipsMeasured) {
        this();
        this.flipsMeasured.setValue(flipsMeasured);
    }
    
    @Override
    protected HMMTestPart3$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        HMMTestPart3$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new HMMTestPart3$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new HMMTestPart3$MultiThreadCPU(target);
                break;
            default:
    ...
    private void transferData(HMMTestPart3$CoreInterface oldCore, HMMTestPart3$CoreInterface newCore) {
        ...
        if(flips.isSet())
            newCore.set$fixedFlag$sample91(oldCore.get$fixedFlag$sample91());
        if(m.isSet())
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(HMMTestPart3 system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(HMMTestPart3 system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(HMMTestPart3 system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(HMMTestPart3 system$model) {
