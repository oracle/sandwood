...
/**
 * Class representing the Sandwood model Flip1CoinMK2 This is the class that all user
 * interactions with the model should occur through.
 */
public final class Flip1CoinMK2 extends Model<Flip1CoinMK2.State> {
    ...
    public Flip1CoinMK2() {
        ...
        Flip1CoinMK2$SingleThreadCPU core = new Flip1CoinMK2$SingleThreadCPU(state, ExecutionTarget.singleThread);
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new Flip1CoinMK2$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new Flip1CoinMK2$MultiThreadCPU(state, target);
            default:
