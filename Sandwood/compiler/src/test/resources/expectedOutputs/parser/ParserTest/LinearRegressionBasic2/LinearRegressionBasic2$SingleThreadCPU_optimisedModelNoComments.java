...
import org.sandwood.compiler.tests.parser.LinearRegressionBasic2$SingleThreadCPU.Scratch;
...
final class LinearRegressionBasic2$SingleThreadCPU extends CoreModelSingleThreadCPU<State, Scratch> {
	...
	public LinearRegressionBasic2$SingleThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
