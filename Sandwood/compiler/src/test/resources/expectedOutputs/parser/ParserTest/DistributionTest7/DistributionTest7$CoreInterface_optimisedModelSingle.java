...
interface DistributionTest7$CoreInterface extends org.sandwood.runtime.internal.model.CoreModel {
	...
	// Setter for cat.
	public void set$cat(int cv$value);
	...
	public void set$distribution$sample31(double[] cv$value);
	...
	public void set$observedData(double cv$value);
	...
	// Setter for var43.
	public void set$var43(int cv$value);
}