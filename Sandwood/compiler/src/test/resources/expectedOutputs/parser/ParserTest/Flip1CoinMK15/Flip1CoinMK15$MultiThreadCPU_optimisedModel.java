	...
	private final void sample12() {
		...
		// Unrolled loop
		{
			...
			if((!guard1 && (0 < c.length))) {
				...
				// 
				// Substituted "cv$reduction383Index" with its value "1".
				// 
				// Copy the result of the reduction into the variable returned by the reduction.
				// 
				// Variable declaration of reduceVar$var28$17 moved.
				...
				if(!guard$sample12bernoulli35) {
					...
					// Set the right hand term to a value from the array c
					// 
					// Substituted "cv$reduction406Index" with its value "0".
					// 
					// Copy the result of the reduction into the variable returned by the reduction.
					// 
					// Variable declaration of reduceVar$var28$18 moved.
		...
		// Constraints moved from conditionals in inner loops/scopes/etc.
			...
			// Set the right hand term to a value from the array c
			// 
			// Substituted "cv$reduction337Index" with its value "1".
			// 
			// Execute the reduction function, saving the result into the return value.
			// 
			// Copy the result of the reduction into the variable returned by the reduction.
			...
			// Set the right hand term to a value from the array c
			// 
			// Substituted "cv$reduction337Index" with its value "0".
			bias = (c[0] + c[1]);
		...
		if((((cv$accumulatedProbabilities - cv$originalProbability) <= Math.log(DistributionSampling.sampleUniform(RNG$))) || Double.isNaN((cv$accumulatedProbabilities - cv$originalProbability)))) {
			...
			// Constraints moved from conditionals in inner loops/scopes/etc.
				...
				// Set the right hand term to a value from the array c
				// 
				// Substituted "cv$reduction455Index" with its value "1".
				// 
				// Execute the reduction function, saving the result into the return value.
				// 
				// Copy the result of the reduction into the variable returned by the reduction.
				...
				// Set the right hand term to a value from the array c
				// 
				// Substituted "cv$reduction455Index" with its value "0".
				bias = (c[0] + c[1]);
		}
	}
