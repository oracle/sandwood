 ...
 */
public final class HMMTestPart5b extends Model<HMMTestPart5b.State> {
...
double[] bias;
    ...
    public HMMTestPart5b() {
        ...
        HMMTestPart5b$SingleThreadCPU core = new HMMTestPart5b$SingleThreadCPU(state, ExecutionTarget.singleThread);
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new HMMTestPart5b$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new HMMTestPart5b$MultiThreadCPU(state, target);
            default:
