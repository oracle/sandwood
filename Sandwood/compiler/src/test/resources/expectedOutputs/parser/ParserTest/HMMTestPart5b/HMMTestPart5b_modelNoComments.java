...
/**
  * Class representing the Sandwood model HMMTestPart5b This is the class that
  * all user interactions with the model should occur through.
  */
public class HMMTestPart5b extends Model {

    private HMMTestPart5b$CoreInterface system$c = new HMMTestPart5b$SingleThreadCPU(ExecutionTarget.singleThread);
    ...
    private final ComputedBooleanArrayInternal $flips = new ComputedBooleanArrayInternal(this, "flips", true) {
        ...
        public void setFixed(boolean fixed) {
            synchronized(model) {
                system$c.set$fixedFlag$sample66(fixed);
            }
        }

        @Override
        public Immutability isFixed() {
            if(system$c.get$fixedFlag$sample66())
                return Immutability.FIXED;
            else
                return Immutability.FREE;
        }
    ...
    private final ComputedIntegerArrayInternal $st = new ComputedIntegerArrayInternal(this, "st", true) {
        ...
        public Immutability isFixed() {
            ...
            if(fixedFlag$sample35 && fixedFlag$sample50)
                return Immutability.FIXED;
            else if(fixedFlag$sample35 || fixedFlag$sample50)
    ...
    public HMMTestPart5b(int flipsMeasuredShape) {
        this();
    ...
    public HMMTestPart5b(boolean[] flipsMeasured) {
        this();
        this.flipsMeasured.set(flipsMeasured);
    }
    
    @Override
    protected HMMTestPart5b$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        HMMTestPart5b$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new HMMTestPart5b$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new HMMTestPart5b$MultiThreadCPU(target);
                break;
            default:
    ...
    private void transferData(HMMTestPart5b$CoreInterface oldCore, HMMTestPart5b$CoreInterface newCore) {
        ...
        if(flips.isSet())
            newCore.set$fixedFlag$sample66(oldCore.get$fixedFlag$sample66());
        if(m.isSet())
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(HMMTestPart5b system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(HMMTestPart5b system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(HMMTestPart5b system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(HMMTestPart5b system$model) {
