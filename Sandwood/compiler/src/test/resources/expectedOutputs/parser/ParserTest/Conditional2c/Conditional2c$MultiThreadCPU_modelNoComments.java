...
import org.sandwood.compiler.tests.parser.Conditional2c$MultiThreadCPU.Scratch;
...
final class Conditional2c$MultiThreadCPU extends CoreModelMultiThreadCPU<State, Scratch> {
...
double[] cv$var4$stateProbabilityGlobal;
	...
	public Conditional2c$MultiThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
