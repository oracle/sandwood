...
/**
 * Class representing the Sandwood model Conditional2b This is the class that all
 * user interactions with the model should occur through.
 */
public final class Conditional2b extends Model<Conditional2b.State> {
...
boolean constrainedFlag$sample4 = true;
    ...
    private final ComputedDoubleArrayInternal $value = new ComputedDoubleArrayInternal(this, "value", false, true, false, ProbabilityType.UNSKIPPABLE) {
        @Override
    ...
    public Conditional2b() {
        ...
        Conditional2b$SingleThreadCPU core = new Conditional2b$SingleThreadCPU(state, ExecutionTarget.singleThread);
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new Conditional2b$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new Conditional2b$MultiThreadCPU(state, target);
            default:
