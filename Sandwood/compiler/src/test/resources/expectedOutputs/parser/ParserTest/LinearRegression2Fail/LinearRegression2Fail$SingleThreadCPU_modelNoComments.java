...
final class LinearRegression2Fail$SingleThreadCPU extends CoreModelSingleThreadCPU<LinearRegression2Fail.State, LinearRegression2Fail$SingleThreadCPU.Scratch> {
	...
	public LinearRegression2Fail$SingleThreadCPU(LinearRegression2Fail.State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
