...
public class Flip1CoinArrayCopyPass extends GeneratedAPIBuilder {
    @Override
    public CompilationDesc buildClass(CompilationOptions opts) {
        ...
        parFor(intVariable(0, location(21, 16, 21, 16)), samples, intVariable(1, location(21, 15, 21, 18)), true, location(21, 5, 21, 27), (i) -> { 
            ...
            flips.put(i, bernoulli.sample(location(23, 30, 23, 37)), location(23, 14, 23, 37));
            bias.put(i.add(intVariable(1, location(24, 16, 24, 16)), location(24, 15, 24, 15)), bias.get(intVariable(0, location(24, 26, 24, 26)), location(24, 25, 24, 27)), location(24, 13, 24, 27));
