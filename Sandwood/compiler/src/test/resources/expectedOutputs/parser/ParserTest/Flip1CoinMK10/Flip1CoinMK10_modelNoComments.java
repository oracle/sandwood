...
/**
 * Class representing the Sandwood model Flip1CoinMK10 This is the class that all
 * user interactions with the model should occur through.
 */
public final class Flip1CoinMK10 extends Model<Flip1CoinMK10.State> {
...
double bias;
    ...
    public Flip1CoinMK10() {
        ...
        Flip1CoinMK10$SingleThreadCPU core = new Flip1CoinMK10$SingleThreadCPU(state, ExecutionTarget.singleThread);
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new Flip1CoinMK10$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new Flip1CoinMK10$MultiThreadCPU(state, target);
            default:
