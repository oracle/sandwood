...
import org.sandwood.compiler.tests.parser.NullModelMK3$MultiThreadCPU.Scratch;
...
final class NullModelMK3$MultiThreadCPU extends CoreModelMultiThreadCPU<State, Scratch> {
	...
	public NullModelMK3$MultiThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
