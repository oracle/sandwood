 ...
 */
public final class DistributionTest6 extends Model<DistributionTest6.State> {
    ...
    public DistributionTest6() {
        ...
        DistributionTest6$SingleThreadCPU core = new DistributionTest6$SingleThreadCPU(state, ExecutionTarget.singleThread);
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new DistributionTest6$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new DistributionTest6$MultiThreadCPU(state, target);
            default:
