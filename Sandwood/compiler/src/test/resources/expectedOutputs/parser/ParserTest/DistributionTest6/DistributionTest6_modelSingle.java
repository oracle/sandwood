...
/**
  * Class representing the Sandwood model DistributionTest6 This is the class that
  * all user interactions with the model should occur through.
  */
public class DistributionTest6 extends Model {

    private DistributionTest6$CoreInterface system$c = new DistributionTest6$SingleThreadCPU(ExecutionTarget.singleThread);
    ...
    private final ComputedBooleanArrayInternal $v = new ComputedBooleanArrayInternal(this, "v", true) {
        ...
        public Immutability isFixed() {
            if(system$c.get$fixedFlag$sample56())
    ...
    private final ComputedIntegerArrayInternal $v2 = new ComputedIntegerArrayInternal(this, "v2", true) {
        ...
        public Immutability isFixed() {
            ...
            if(fixedFlag$sample18 && fixedFlag$sample34)
                return Immutability.FIXED;
            else if(fixedFlag$sample18 || fixedFlag$sample34)
    ...
    public DistributionTest6(double[] weightings, int valueShape) {
        this();
    ...
    public DistributionTest6(double[] weightings, boolean[] value) {
        this();
        this.weightings.setValue(weightings);
    ...
    @Override
    protected DistributionTest6$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        DistributionTest6$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new DistributionTest6$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new DistributionTest6$MultiThreadCPU(target);
                break;
            default:
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(DistributionTest6 system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(DistributionTest6 system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(DistributionTest6 system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(DistributionTest6 system$model) {
