...
public class HMM_Mk2 extends GeneratedAPIBuilder {
    @Override
    public CompilationDesc buildClass(CompilationOptions opts) {
        //Allocating initial observed parameters
        ArrayVariable<ArrayVariable<IntVariable>> eventsMeasured = observeArray("eventsMeasured", VariableType.arrayType(VariableType.arrayType(VariableType.IntVariable)), location(11, 15, 11, 36));
        IntVariable noStates = observeInt("noStates", location(11, 39, 11, 50));
        IntVariable noEvents = observeInt("noEvents", location(11, 53, 11, 64));
        ...
        parFor(intVariable(0, location(34, 20, 34, 20)), samples, intVariable(1, location(34, 19, 34, 22)), true, location(34, 9, 34, 31), (i) -> { 
            ...
            st.get(i, location(35, 15, 35, 17)).put(intVariable(0, location(35, 19, 35, 19)), categorical(m.get(initialState, location(35, 37, 35, 50)), location(35, 24, 35, 51)).sample(location(35, 53, 35, 60)), location(35, 18, 35, 60));
        ...
        parFor(intVariable(0, location(39, 20, 39, 20)), samples, intVariable(1, location(39, 19, 39, 23)), true, location(39, 9, 39, 33), (i) -> { 
            ...
            parFor(intVariable(1, location(41, 24, 41, 24)), streamLength, intVariable(1, location(41, 23, 41, 26)), true, location(41, 13, 41, 40), (j) -> { 
                ...
                st.get(i, location(42, 19, 42, 21)).put(j, categorical(m.get(st.get(i, location(42, 44, 42, 46)).get(j.subtract(intVariable(1, location(42, 50, 42, 50)), location(42, 49, 42, 49)), location(42, 47, 42, 51)), location(42, 41, 42, 52)), location(42, 28, 42, 53)).sample(location(42, 55, 42, 62)), location(42, 22, 42, 62));
        ...
        return compileAPI(opts, $variableNames, "HMM_Mk2", $helperClasses, "org.sandwood.compiler.tests.parser", $constructorArgs, getOriginalModel(), null);
    }
