										...
										if((j$var20 == j$var38)) {
											...
											if(((0 <= j$var38) && (j$var38 < state.noProducts))) {
												if((0 < state.noProducts)) {
													...
													for(int cv$reduction2539Index = 0; cv$reduction2539Index < j$var38; cv$reduction2539Index += 1) {
														// Set the left hand term of the reduction function to the return variable value.
														double k$var49 = reduceVar$sum$12;
														
														// Set the right hand term to a value from the array exped
														double l$var50 = state.exped[cv$reduction2539Index];
													...
													for(int cv$reduction2539Index = (j$var38 + 1); cv$reduction2539Index < state.noProducts; cv$reduction2539Index += 1) {
														// Set the left hand term of the reduction function to the return variable value.
														double k$var49 = reduceVar$sum$12;
																...
																for(int t$var105 = 0; t$var105 < state.T; t$var105 += 1) {
																	...
																	if(((0 <= j$var116) && (j$var116 < state.noProducts))) {
																		if((0 < state.noProducts)) {
																			...
																			// Reduce for every value except a masked value which will be skipped.
																			for(int cv$reduction2573Index = 0; cv$reduction2573Index < j$var116; cv$reduction2573Index += 1) {
																				// Set the left hand term of the reduction function to the return variable value.
																				double k$var128 = reduceVar$denom$24;
																				
																				// Set the right hand term to a value from the array weekly_ut
																				double l$var129 = state.weekly_ut[((t$var105 - 0) / 1)][cv$reduction2573Index];
																			...
																			for(int cv$reduction2573Index = (j$var116 + 1); cv$reduction2573Index < state.noProducts; cv$reduction2573Index += 1) {
																				// Set the left hand term of the reduction function to the return variable value.
																				double k$var128 = reduceVar$denom$24;
										...
										if((j$var20 == j$var38)) {
											...
											if(((0 <= j$var38) && (j$var38 < state.noProducts))) {
												if((0 < state.noProducts)) {
													...
													// Reduce for every value except a masked value which will be skipped.
													for(int cv$reduction2601Index = 0; cv$reduction2601Index < j$var38; cv$reduction2601Index += 1) {
														// Set the left hand term of the reduction function to the return variable value.
														double k$var49 = reduceVar$sum$13;
														
														// Set the right hand term to a value from the array exped
														double l$var50 = state.exped[cv$reduction2601Index];
													...
													for(int cv$reduction2601Index = (j$var38 + 1); cv$reduction2601Index < state.noProducts; cv$reduction2601Index += 1) {
														// Set the left hand term of the reduction function to the return variable value.
														double k$var49 = reduceVar$sum$13;
																...
																if(((0 <= j$var116) && (j$var116 < state.noProducts))) {
																	if((0 < state.noProducts)) {
																		...
																		for(int cv$reduction2657Index = 0; cv$reduction2657Index < j$var116; cv$reduction2657Index += 1) {
																			...
																			// Set the right hand term to a value from the array weekly_ut
																			double l$var129 = state.weekly_ut[((t$var105 - 0) / 1)][cv$reduction2657Index];
																		...
																		for(int cv$reduction2657Index = (j$var116 + 1); cv$reduction2657Index < state.noProducts; cv$reduction2657Index += 1) {
																			// Set the left hand term of the reduction function to the return variable value.
																			double k$var128 = reduceVar$denom$25;
