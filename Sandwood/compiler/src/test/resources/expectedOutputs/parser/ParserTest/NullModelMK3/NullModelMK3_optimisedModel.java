...
/**
  * Class representing the Sandwood model NullModelMK3 This is the class that
  * all user interactions with the model should occur through.
  */
public class NullModelMK3 extends Model {
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(NullModelMK3 system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(NullModelMK3 system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(NullModelMK3 system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(NullModelMK3 system$model) {
