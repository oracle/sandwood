...
public class HMMTestPart1b extends Model {
    ...
    public HMMTestPart1b(boolean flipMeasured) {
        this();
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(HMMTestPart1b system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(HMMTestPart1b system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(HMMTestPart1b system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(HMMTestPart1b system$model) {
