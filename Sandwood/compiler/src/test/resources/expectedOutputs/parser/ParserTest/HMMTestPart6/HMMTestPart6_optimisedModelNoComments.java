...
/**
  * Class representing the Sandwood model HMMTestPart6 This is the class that
  * all user interactions with the model should occur through.
  */
public class HMMTestPart6 extends Model {

    private HMMTestPart6$CoreInterface system$c = new HMMTestPart6$SingleThreadCPU(ExecutionTarget.singleThread);
    ...
    private final ComputedIntegerArrayInternal $st = new ComputedIntegerArrayInternal(this, "st", true) {
        ...
        public Immutability isFixed() {
            ...
            if(fixedFlag$sample35 && fixedFlag$sample52)
                return Immutability.FIXED;
            else if(fixedFlag$sample35 || fixedFlag$sample52)
    ...
    public HMMTestPart6(int flipsMeasuredShape) {
        this();
    ...
    public HMMTestPart6(boolean[] flipsMeasured) {
        this();
        this.flipsMeasured.setValue(flipsMeasured);
    }
    
    @Override
    protected HMMTestPart6$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        HMMTestPart6$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new HMMTestPart6$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new HMMTestPart6$MultiThreadCPU(target);
                break;
            default:
    ...
    private void transferData(HMMTestPart6$CoreInterface oldCore, HMMTestPart6$CoreInterface newCore) {
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(HMMTestPart6 system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(HMMTestPart6 system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(HMMTestPart6 system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(HMMTestPart6 system$model) {
