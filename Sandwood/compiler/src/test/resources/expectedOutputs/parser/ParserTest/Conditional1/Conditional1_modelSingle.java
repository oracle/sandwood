...
/**
 * Class representing the Sandwood model Conditional1 This is the class that all user
 * interactions with the model should occur through.
 */
public final class Conditional1 extends Model<Conditional1.State> {
    ...
    private HasProbabilityInternal[] $probabilityVariables = {$guard, $value, $bernoulli};
    ...
    public Conditional1() {
        ...
        Conditional1$SingleThreadCPU core = new Conditional1$SingleThreadCPU(state, ExecutionTarget.singleThread);
	 ...
	 */
    public Conditional1(double observedValue) {
        this();
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new Conditional1$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new Conditional1$MultiThreadCPU(state, target);
            default:
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(Conditional1 system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(Conditional1 system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(Conditional1 system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(Conditional1 system$model) {
