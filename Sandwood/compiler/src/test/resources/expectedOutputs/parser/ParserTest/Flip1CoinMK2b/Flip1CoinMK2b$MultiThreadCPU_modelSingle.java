...
import org.sandwood.compiler.tests.parser.Flip1CoinMK2b$MultiThreadCPU.Scratch;
...
final class Flip1CoinMK2b$MultiThreadCPU extends CoreModelMultiThreadCPU<State, Scratch> {
	...
	public Flip1CoinMK2b$MultiThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
