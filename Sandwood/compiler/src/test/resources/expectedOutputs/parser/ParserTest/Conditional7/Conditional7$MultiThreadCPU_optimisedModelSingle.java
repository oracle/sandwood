...
class Conditional7$MultiThreadCPU extends org.sandwood.runtime.internal.model.CoreModelMultiThreadCPU implements Conditional7$CoreInterface {
	...
	public Conditional7$MultiThreadCPU(ExecutionTarget target) {
		super(target);
	}
