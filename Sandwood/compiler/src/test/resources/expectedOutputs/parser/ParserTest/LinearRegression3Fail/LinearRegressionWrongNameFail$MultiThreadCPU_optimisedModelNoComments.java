...
import org.sandwood.compiler.tests.parser.LinearRegressionWrongNameFail$MultiThreadCPU.Scratch;
...
final class LinearRegressionWrongNameFail$MultiThreadCPU extends CoreModelMultiThreadCPU<State, Scratch> {
	...
	public LinearRegressionWrongNameFail$MultiThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
