...
interface AnonymousSample$CoreInterface extends org.sandwood.runtime.internal.model.CoreModel {
	...
	public void set$length$obsAmounts1(int cv$value, boolean allocated$);
	...
	// Setter for mean1.
	public void set$mean1(double cv$value, boolean allocated$);

	// Getter for mean2.
	public double get$mean2();

	// Setter for mean2.
	public void set$mean2(double cv$value, boolean allocated$);
	...
	public void set$obsAmounts1(double[] cv$value, boolean allocated$);

	// Getter for obsAmounts2.
	public double[] get$obsAmounts2();

	// Setter for obsAmounts2.
	public void set$obsAmounts2(double[] cv$value, boolean allocated$);

	// Getter for priorSigma2.
	public double get$priorSigma2();

	// Setter for priorSigma2.
	public void set$priorSigma2(double cv$value, boolean allocated$);
}