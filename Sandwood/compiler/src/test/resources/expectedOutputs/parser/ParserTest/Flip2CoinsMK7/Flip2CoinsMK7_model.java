...
/**
 * Class representing the Sandwood model Flip2CoinsMK7 This is the class that all
 * user interactions with the model should occur through.
 */
public final class Flip2CoinsMK7 extends Model {
    private Flip2CoinsMK7$CoreInterface system$c = new Flip2CoinsMK7$SingleThreadCPU(ExecutionTarget.singleThread);
	 ...
	 */
    public Flip2CoinsMK7(double a, double b, int[] flipsMeasuredShape) {
        this();
        this.$a.setValue(a);
        this.$b.setValue(b);
	 ...
	 */
    public Flip2CoinsMK7(double a, double b, boolean[][] flipsMeasured) {
        this();
        this.a.setValue(a);
        this.b.setValue(b);
    ...
    @Override
    protected Flip2CoinsMK7$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        Flip2CoinsMK7$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new Flip2CoinsMK7$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new Flip2CoinsMK7$MultiThreadCPU(target);
                break;
            default:
    ...
    private void transferData(Flip2CoinsMK7$CoreInterface oldCore, Flip2CoinsMK7$CoreInterface newCore) {
        //Model inputs
        if(a.isSet())
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(Flip2CoinsMK7 system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(Flip2CoinsMK7 system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(Flip2CoinsMK7 system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(Flip2CoinsMK7 system$model) {
