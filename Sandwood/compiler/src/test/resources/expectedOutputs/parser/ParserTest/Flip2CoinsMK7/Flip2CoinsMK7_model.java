 ...
 */
public final class Flip2CoinsMK7 extends Model<Flip2CoinsMK7.State> {
    ...
    public Flip2CoinsMK7() {
        ...
        Flip2CoinsMK7$SingleThreadCPU core = new Flip2CoinsMK7$SingleThreadCPU(state, ExecutionTarget.singleThread);
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new Flip2CoinsMK7$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new Flip2CoinsMK7$MultiThreadCPU(state, target);
            default:
