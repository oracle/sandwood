...
public class Deterministic extends GeneratedAPIBuilder {
    @Override
    public CompilationDesc buildClass(CompilationOptions opts) {
        //Allocating initial observed parameters
        IntVariable n = observeInt("n", location(14, 28, 14, 32));
        ArrayVariable<BooleanVariable> flipsMeasured = observeArray("flipsMeasured", VariableType.arrayType(VariableType.BooleanVariable), location(14, 35, 14, 57));
        ...
        parFor(intVariable(1, location(26, 15, 26, 15)), n, intVariable(1, location(26, 23, 26, 25)), true, location(26, 5, 26, 26), (i) -> {
            ...
            a.put(i, categorical(m.get(b.get(i, location(28, 31, 28, 33)), location(28, 29, 28, 34)), location(28, 16, 28, 35)).sample(location(28, 37, 28, 44)), location(28, 10, 28, 44));
        ...
        return compileAPI(opts, $variableNames, "Deterministic", $helperClasses, "org.sandwood.compiler.tests.parser", $constructorArgs, getOriginalModel(), "A model for the fairness work.");
    }
