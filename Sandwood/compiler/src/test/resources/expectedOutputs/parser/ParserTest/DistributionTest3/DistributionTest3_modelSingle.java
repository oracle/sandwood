...
/**
  * Class representing the Sandwood model DistributionTest3 This is the class that
  * all user interactions with the model should occur through.
  */
public final class DistributionTest3 extends Model {

    private DistributionTest3$CoreInterface system$c = new DistributionTest3$SingleThreadCPU(ExecutionTarget.singleThread);
    ...
    public DistributionTest3(double[] weightings) {
        this();
    ...
    public DistributionTest3(double[] weightings, boolean value) {
        this();
        this.weightings.setValue(weightings);
    ...
    @Override
    protected DistributionTest3$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        DistributionTest3$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new DistributionTest3$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new DistributionTest3$MultiThreadCPU(target);
                break;
            default:
    ...
    private void transferData(DistributionTest3$CoreInterface oldCore, DistributionTest3$CoreInterface newCore) {
        //Model inputs
        if(weightings.isSet())
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(DistributionTest3 system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(DistributionTest3 system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(DistributionTest3 system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(DistributionTest3 system$model) {
