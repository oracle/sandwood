...
class HMMTestPart5$MultiThreadCPU extends org.sandwood.runtime.internal.model.CoreModelMultiThreadCPU implements HMMTestPart5$CoreInterface {
	...
	public final void set$fixedFlag$sample26(boolean cv$value) {
		...
		fixedProbFlag$sample56 = (fixedFlag$sample26 && fixedProbFlag$sample56);
	}
	...
	public final void set$fixedFlag$sample35(boolean cv$value) {
		...
		fixedProbFlag$sample56 = (fixedFlag$sample35 && fixedProbFlag$sample56);
	}
	...
	public final void set$fixedFlag$sample46(boolean cv$value) {
		...
		fixedProbFlag$sample56 = (fixedFlag$sample46 && fixedProbFlag$sample56);
	}
	...
	public final void allocator() {
		...
		{
			logProbability$sample56 = new double[((((length$flipsMeasured - 1) - 0) / 1) + 1)];
		}
		allocateScratch();
	}
