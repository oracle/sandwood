...
/**
 * Class representing the Sandwood model HMMTestPart3 This is the class that all user
 * interactions with the model should occur through.
 */
public final class HMMTestPart3 extends Model<HMMTestPart3.State> {
...
double[] bias;
    ...
    public HMMTestPart3() {
        ...
        HMMTestPart3$SingleThreadCPU core = new HMMTestPart3$SingleThreadCPU(state, ExecutionTarget.singleThread);
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new HMMTestPart3$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new HMMTestPart3$MultiThreadCPU(state, target);
            default:
