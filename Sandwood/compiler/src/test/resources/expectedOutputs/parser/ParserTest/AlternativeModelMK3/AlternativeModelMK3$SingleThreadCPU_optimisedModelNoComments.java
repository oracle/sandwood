...
import org.sandwood.compiler.tests.parser.AlternativeModelMK3$SingleThreadCPU.Scratch;
import org.sandwood.compiler.tests.parser.AlternativeModelMK3.State;
...
final class AlternativeModelMK3$SingleThreadCPU extends CoreModelSingleThreadCPU<State, Scratch> {
	...
	public AlternativeModelMK3$SingleThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
