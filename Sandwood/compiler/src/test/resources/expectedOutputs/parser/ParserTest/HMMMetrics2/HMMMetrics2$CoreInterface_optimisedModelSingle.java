...
interface HMMMetrics2$CoreInterface extends org.sandwood.runtime.internal.model.CoreModel {
	...
	public void set$fixedFlag$sample68(boolean cv$value, boolean allocated$);
	...
	public void set$length$metric(int[] cv$value, boolean allocated$);
	...
	// Setter for metric.
	public void set$metric(double[][] cv$value, boolean allocated$);
	...
	public void set$metric_mean(double[] cv$value, boolean allocated$);

	// Getter for metric_valid.
	public boolean[][] get$metric_valid();

	// Setter for metric_valid.
	public void set$metric_valid(boolean[][] cv$value, boolean allocated$);

	// Getter for metric_valid_bias.
	public double[] get$metric_valid_bias();

	// Setter for metric_valid_bias.
	public void set$metric_valid_bias(double[] cv$value, boolean allocated$);
	...
	public void set$metric_var(double[] cv$value, boolean allocated$);
