...
import org.sandwood.compiler.tests.parser.HMMTest$SingleThreadCPU.Scratch;
import org.sandwood.compiler.tests.parser.HMMTest.State;
...
final class HMMTest$SingleThreadCPU extends CoreModelSingleThreadCPU<State, Scratch> {
	...
	public HMMTest$SingleThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
	...
	private final void drawValueSample69(int i$var62) {
		state.st[i$var62] = DistributionSampling.sampleCategorical(state.RNG$, state.m[state.st[(i$var62 - 1)]], state.states);
	}
					...
					{
						{
							for(int i$var62 = 1; i$var62 < state.samples; i$var62 += 1) {
								if((var27 == state.st[(i$var62 - 1)])) {
									// Processing sample task 69 of consumer random variable null.
									{
										{
											// Flag recording if this sample task of the consuming random variable is constrained.
											boolean cv$sampleConstrained = (state.fixedFlag$sample69 || state.constrainedFlag$sample69[((i$var62 - 1) / 1)]);
	...
	private final void inferSample69(int i$var62) {
		if(true) {
			state.constrainedFlag$sample69[((i$var62 - 1) / 1)] = false;
			...
			double[] cv$stateProbabilityLocal = scratch.cv$var68$stateProbabilityGlobal;
			for(int cv$valuePos = 0; cv$valuePos < cv$numStates; cv$valuePos += 1) {
				...
				// Guards to ensure that st is only updated when there is a valid path.
				{
					{
						{
							state.st[i$var62] = cv$currentValue;
						}
					}
				}
				{
					...
					double cv$accumulatedProbabilities = (Math.log(1.0) + ((((((0.0 <= cv$currentValue) && (cv$currentValue < state.states)) && (0 < state.states)) && (0.0 <= var66[cv$currentValue])) && (var66[cv$currentValue] <= 1.0))?Math.log(var66[cv$currentValue]):Double.NEGATIVE_INFINITY));
								...
								for(int index$i$2_2 = 1; index$i$2_2 < state.samples; index$i$2_2 += 1) {
									if((i$var62 == (index$i$2_2 - 1))) {
										// Processing sample task 69 of consumer random variable null.
										{
											{
												// Flag recording if this sample task of the consuming random variable is constrained.
												boolean cv$sampleConstrained = (state.fixedFlag$sample69 || state.constrainedFlag$sample69[((index$i$2_2 - 1) / 1)]);
												if(cv$sampleConstrained) {
													// Mark that the sample has observed constrained data.
													state.constrainedFlag$sample69[((i$var62 - 1) / 1)] = true;
															...
															{
																{
																	{
																		// Constructing a random variable input for use later.
																		double[] sc$var66$1 = state.m[traceTempVariable$var65$2_1];
																		
																		// Record the probability of sample task 69 generating output with current configuration.
																		if(((Math.log(1.0) + ((((((0.0 <= state.st[index$i$2_2]) && (state.st[index$i$2_2] < state.states)) && (0 < state.states)) && (0.0 <= sc$var66$1[state.st[index$i$2_2]])) && (sc$var66$1[state.st[index$i$2_2]] <= 1.0))?Math.log(sc$var66$1[state.st[index$i$2_2]]):Double.NEGATIVE_INFINITY)) < cv$accumulatedConsumerProbabilities))
																			cv$accumulatedConsumerProbabilities = (Math.log((Math.exp(((Math.log(1.0) + ((((((0.0 <= state.st[index$i$2_2]) && (state.st[index$i$2_2] < state.states)) && (0 < state.states)) && (0.0 <= sc$var66$1[state.st[index$i$2_2]])) && (sc$var66$1[state.st[index$i$2_2]] <= 1.0))?Math.log(sc$var66$1[state.st[index$i$2_2]]):Double.NEGATIVE_INFINITY)) - cv$accumulatedConsumerProbabilities)) + 1)) + cv$accumulatedConsumerProbabilities);
																		else {
																			// If the second value is -infinity.
																			if((cv$accumulatedConsumerProbabilities == Double.NEGATIVE_INFINITY))
																				cv$accumulatedConsumerProbabilities = (Math.log(1.0) + ((((((0.0 <= state.st[index$i$2_2]) && (state.st[index$i$2_2] < state.states)) && (0 < state.states)) && (0.0 <= sc$var66$1[state.st[index$i$2_2]])) && (sc$var66$1[state.st[index$i$2_2]] <= 1.0))?Math.log(sc$var66$1[state.st[index$i$2_2]]):Double.NEGATIVE_INFINITY));
																			else
															...
															{
																{
																	{
																		// Constructing a random variable input for use later.
																		double var81 = state.bias[traceTempVariable$var80$5_1];
																		
																		// Record the probability of sample task 84 generating output with current configuration.
																		if(((Math.log(1.0) + (((0.0 <= var81) && (var81 <= 1.0))?Math.log((state.flips[j]?var81:(1.0 - var81))):Double.NEGATIVE_INFINITY)) < cv$accumulatedConsumerProbabilities))
																			cv$accumulatedConsumerProbabilities = (Math.log((Math.exp(((Math.log(1.0) + (((0.0 <= var81) && (var81 <= 1.0))?Math.log((state.flips[j]?var81:(1.0 - var81))):Double.NEGATIVE_INFINITY)) - cv$accumulatedConsumerProbabilities)) + 1)) + cv$accumulatedConsumerProbabilities);
																		else {
																			// If the second value is -infinity.
																			if((cv$accumulatedConsumerProbabilities == Double.NEGATIVE_INFINITY))
																				cv$accumulatedConsumerProbabilities = (Math.log(1.0) + (((0.0 <= var81) && (var81 <= 1.0))?Math.log((state.flips[j]?var81:(1.0 - var81))):Double.NEGATIVE_INFINITY));
																			else
																				cv$accumulatedConsumerProbabilities = (Math.log((Math.exp((cv$accumulatedConsumerProbabilities - (Math.log(1.0) + (((0.0 <= var81) && (var81 <= 1.0))?Math.log((state.flips[j]?var81:(1.0 - var81))):Double.NEGATIVE_INFINITY)))) + 1)) + (Math.log(1.0) + (((0.0 <= var81) && (var81 <= 1.0))?Math.log((state.flips[j]?var81:(1.0 - var81))):Double.NEGATIVE_INFINITY)));
																		}
			...
			if(state.constrainedFlag$sample69[((i$var62 - 1) / 1)]) {
				...
				// Write out the value of the sample to a temporary variable prior to updating the
				// intermediate variables.
				int var68 = DistributionSampling.sampleCategorical(state.RNG$, cv$stateProbabilityLocal, cv$numStates);
				
				// Guards to ensure that st is only updated when there is a valid path.
				{
					{
						{
							state.st[i$var62] = var68;
						}
					}
				}
			}
	...
	private final void logProbabilityValue$sample69() {
		...
		if(!state.fixedProbFlag$sample69) {
			...
			for(int i$var62 = 1; i$var62 < state.samples; i$var62 += 1) {
						...
						{
							{
								...
								// Store the value of the function call, so the function call is only made once.
								double cv$weightedProbability = (Math.log(1.0) + ((((((0.0 <= cv$sampleValue) && (cv$sampleValue < state.states)) && (0 < state.states)) && (0.0 <= var66[cv$sampleValue])) && (var66[cv$sampleValue] <= 1.0))?Math.log(var66[cv$sampleValue]):Double.NEGATIVE_INFINITY));
				...
				state.logProbability$sample69[((i$var62 - 1) / 1)] = cv$sampleProbability;
			}
			...
			for(int i$var62 = 1; i$var62 < state.samples; i$var62 += 1) {
				double cv$rvAccumulator = 0.0;
				double cv$sampleValue = state.logProbability$sample69[((i$var62 - 1) / 1)];
				cv$rvAccumulator = (cv$rvAccumulator + cv$sampleValue);
	...
	private final void logProbabilityValue$sample84() {
		...
		if(!state.fixedProbFlag$sample84) {
			...
			for(int j = 0; j < state.samples; j += 1) {
				...
				// Store the sample task probability
				state.logProbability$sample84[((j - 0) / 1)] = cv$sampleProbability;
			}
			...
			for(int j = 0; j < state.samples; j += 1) {
				double cv$rvAccumulator = 0.0;
				double cv$sampleValue = state.logProbability$sample84[((j - 0) / 1)];
				cv$rvAccumulator = (cv$rvAccumulator + cv$sampleValue);
	...
	public final void gibbsRound() {
		...
		// Infer the samples in reverse chronological order.
			...
			for(int i$var62 = (state.samples - ((((state.samples - 1) - 1) % 1) + 1)); i$var62 >= ((1 - 1) + 1); i$var62 -= 1) {
				if(!state.fixedFlag$sample69)
					inferSample69(i$var62);
			}
	...
	private final void initializeLogProbabilityFields() {
		...
		if(!state.fixedProbFlag$sample69) {
			for(int i$var62 = 1; i$var62 < state.samples; i$var62 += 1)
				state.logProbability$sample69[((i$var62 - 1) / 1)] = Double.NaN;
		}
		state.logProbability$flips = 0.0;
		if(!state.fixedProbFlag$sample84) {
			for(int j = 0; j < state.samples; j += 1)
				state.logProbability$sample84[((j - 0) / 1)] = Double.NaN;
		}
	}
