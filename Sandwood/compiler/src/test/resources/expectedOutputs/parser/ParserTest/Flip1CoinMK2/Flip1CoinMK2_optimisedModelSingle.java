...
/**
  * Class representing the Sandwood model Flip1CoinMK2 This is the class that
  * all user interactions with the model should occur through.
  */
public final class Flip1CoinMK2 extends Model {

    private Flip1CoinMK2$CoreInterface system$c = new Flip1CoinMK2$SingleThreadCPU(ExecutionTarget.singleThread);
    ...
    public Flip1CoinMK2(int samples) {
        this();
    ...
    public Flip1CoinMK2(int samples, boolean[] flipsMeasured) {
        this();
        this.samples.setValue(samples);
    ...
    @Override
    protected Flip1CoinMK2$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        Flip1CoinMK2$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new Flip1CoinMK2$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new Flip1CoinMK2$MultiThreadCPU(target);
                break;
            default:
    ...
    private void transferData(Flip1CoinMK2$CoreInterface oldCore, Flip1CoinMK2$CoreInterface newCore) {
        //Model inputs
        if(samples.isSet())
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(Flip1CoinMK2 system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(Flip1CoinMK2 system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(Flip1CoinMK2 system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(Flip1CoinMK2 system$model) {
