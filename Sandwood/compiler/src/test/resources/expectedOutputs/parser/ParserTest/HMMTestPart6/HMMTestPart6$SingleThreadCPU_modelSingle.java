...
class HMMTestPart6$SingleThreadCPU extends org.sandwood.runtime.internal.model.CoreModelSingleThreadCPU implements HMMTestPart6$CoreInterface {
	...
	private double logProbability$var104;
	...
	private final void logProbabilityValue$sample107() {
		...
		if(!fixedProbFlag$sample107) {
			...
			logProbability$var103 = cv$sampleAccumulator;
			
			// Store the random variable instance probability
			logProbability$var104 = cv$accumulator;
		...
		// Using cached values.
			...
			double cv$sampleValue = logProbability$var104;
			cv$rvAccumulator = (cv$rvAccumulator + cv$sampleValue);
			cv$accumulator = (cv$accumulator + cv$rvAccumulator);
			logProbability$var103 = cv$rvAccumulator;
	...
	private final void logProbabilityValue$sample82() {
		...
		if(!fixedProbFlag$sample82) {
			...
			// Store the random variable instance probability
			logProbability$var79 = cv$accumulator;
	...
	private final void initializeLogProbabilityFields() {
		...
		logProbability$var103 = 0.0;
		logProbability$flips = 0.0;
		if(!fixedProbFlag$sample107)
			logProbability$var104 = 0.0;
	}
