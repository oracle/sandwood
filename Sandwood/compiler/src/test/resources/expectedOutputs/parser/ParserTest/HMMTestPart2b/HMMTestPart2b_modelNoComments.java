...
/**
  * Class representing the Sandwood model HMMTestPart2b This is the class that
  * all user interactions with the model should occur through.
  */
public final class HMMTestPart2b extends Model {

    private HMMTestPart2b$CoreInterface system$c = new HMMTestPart2b$SingleThreadCPU(ExecutionTarget.singleThread);
    ...
    @Override
    protected HMMTestPart2b$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        HMMTestPart2b$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new HMMTestPart2b$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new HMMTestPart2b$MultiThreadCPU(target);
                break;
            default:
    ...
    private void transferData(HMMTestPart2b$CoreInterface oldCore, HMMTestPart2b$CoreInterface newCore) {
