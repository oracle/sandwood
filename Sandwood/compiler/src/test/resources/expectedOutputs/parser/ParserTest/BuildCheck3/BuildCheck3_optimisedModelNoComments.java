 ...
 */
public class BuildCheck3 extends Model {

    private BuildCheck3$CoreInterface system$c = new BuildCheck3$SingleThreadCPU(ExecutionTarget.singleThread);
    ...
    private final ComputedBooleanInternal $deploy_action_certainty = new ComputedBooleanInternal(this, "deploy_action_certainty", false) {
        ...
        public Immutability isFixed() {
            ...
            else if(fixedFlag$sample46 || fixedFlag$sample48 || fixedFlag$sample51 || fixedFlag$sample54)
    ...
    private final ComputedBooleanInternal $deploy_command_certainty = new ComputedBooleanInternal(this, "deploy_command_certainty", false) {
        ...
        public Immutability isFixed() {
            ...
            boolean fixedFlag$sample89 = system$c.get$fixedFlag$sample89();
            if(fixedFlag$sample84 && fixedFlag$sample86 && fixedFlag$sample89)
                return Immutability.FIXED;
            else if(fixedFlag$sample84 || fixedFlag$sample86 || fixedFlag$sample89)
                return Immutability.PARTIALLY_FIXED;
            else
                return Immutability.FREE;
        }
    ...
    private final ObservedBooleanInternal $release_workflow_trigger_deploy_action = new ObservedBooleanInternal(this, "release_workflow_trigger_deploy_action") {
        @Override
        public boolean get() {
            synchronized(model) {
                return system$c.get$release_workflow_trigger_deploy_action();
            }
        }

        @Override
        protected void setValue(boolean value) { system$c.set$release_workflow_trigger_deploy_action(value); }
    };

    /**
     * Observed variable representing release_workflow_trigger_deploy_action of type boolean from the Sandwood model 
     */
    public final ObservedBoolean release_workflow_trigger_deploy_action = $release_workflow_trigger_deploy_action;

    private final ObservedBooleanInternal $release_workflow_trigger_deploy_command = new ObservedBooleanInternal(this, "release_workflow_trigger_deploy_command") {
        @Override
        public boolean get() {
            synchronized(model) {
                return system$c.get$release_workflow_trigger_deploy_command();
            }
        }

        @Override
        protected void setValue(boolean value) { system$c.set$release_workflow_trigger_deploy_command(value); }
    };

    /**
     * Observed variable representing release_workflow_trigger_deploy_command of type boolean from the Sandwood model 
     */
    public final ObservedBoolean release_workflow_trigger_deploy_command = $release_workflow_trigger_deploy_command;

    private final ObservedBooleanInternal $step_uses_secrets_deploy_action = new ObservedBooleanInternal(this, "step_uses_secrets_deploy_action") {
        @Override
        public boolean get() {
            synchronized(model) {
                return system$c.get$step_uses_secrets_deploy_action();
            }
        }

        @Override
        protected void setValue(boolean value) { system$c.set$step_uses_secrets_deploy_action(value); }
    };

    /**
     * Observed variable representing step_uses_secrets_deploy_action of type boolean from the Sandwood model 
     */
    public final ObservedBoolean step_uses_secrets_deploy_action = $step_uses_secrets_deploy_action;

    private final ObservedBooleanInternal $step_uses_secrets_deploy_command = new ObservedBooleanInternal(this, "step_uses_secrets_deploy_command") {
        @Override
        public boolean get() {
            synchronized(model) {
                return system$c.get$step_uses_secrets_deploy_command();
            }
        }

        @Override
        protected void setValue(boolean value) { system$c.set$step_uses_secrets_deploy_command(value); }
    };

    /**
     * Observed variable representing step_uses_secrets_deploy_command of type boolean from the Sandwood model 
     */
    public final ObservedBoolean step_uses_secrets_deploy_command = $step_uses_secrets_deploy_command;
    ...
    public BuildCheck3() {
        ...
        $modelInputs.put("release_workflow_trigger_deploy_action", $release_workflow_trigger_deploy_action);
        $modelInputs.put("release_workflow_trigger_deploy_command", $release_workflow_trigger_deploy_command);
        $modelInputs.put("step_uses_secrets_deploy_action", $step_uses_secrets_deploy_action);
        $modelInputs.put("step_uses_secrets_deploy_command", $step_uses_secrets_deploy_command);
    ...
    /**
      ...
      * @param release_workflow_trigger_deploy_command The value to set release_workflow_trigger_deploy_command to.
      * @param release_workflow_trigger_deploy_action The value to set release_workflow_trigger_deploy_action to.
      ...
      * @param step_uses_secrets_deploy_action The value to set step_uses_secrets_deploy_action to.
      * @param step_uses_secrets_deploy_command The value to set step_uses_secrets_deploy_command to.
      */

    public BuildCheck3(boolean deploy_action, boolean deploy_command, boolean deploy_kws, boolean release_workflow_trigger_deploy_command, boolean release_workflow_trigger_deploy_action, boolean invalid_trigger, boolean tested_deploy_action, boolean step_uses_secrets_deploy_action, boolean step_uses_secrets_deploy_command) {
        this();
        this.deploy_action.set(deploy_action);
        this.deploy_command.set(deploy_command);
        this.deploy_kws.set(deploy_kws);
        this.release_workflow_trigger_deploy_command.set(release_workflow_trigger_deploy_command);
        this.release_workflow_trigger_deploy_action.set(release_workflow_trigger_deploy_action);
        this.invalid_trigger.set(invalid_trigger);
        this.tested_deploy_action.set(tested_deploy_action);
        this.step_uses_secrets_deploy_action.set(step_uses_secrets_deploy_action);
        this.step_uses_secrets_deploy_command.set(step_uses_secrets_deploy_command);
    }
    
    @Override
    protected BuildCheck3$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        BuildCheck3$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new BuildCheck3$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new BuildCheck3$MultiThreadCPU(target);
                break;
            default:
    ...
    private void transferData(BuildCheck3$CoreInterface oldCore, BuildCheck3$CoreInterface newCore) {
        //Model inputs
    ...
    public static class InferValueInputs {
        ...
        /** Field holding the value of model input release_workflow_trigger_deploy_command */
        public final boolean release_workflow_trigger_deploy_command;
        /** Field holding the value of model input release_workflow_trigger_deploy_action */
        ...
        /** Field holding the value of model input step_uses_secrets_deploy_action */
        public final boolean step_uses_secrets_deploy_action;
        /** Field holding the value of model input step_uses_secrets_deploy_command */
        ...
        /**
          ...
          * @param step_uses_secrets_deploy_command The value to set step_uses_secrets_deploy_command to.
          */
        public InferValueInputs(boolean deploy_action, boolean deploy_command, boolean deploy_kws, boolean release_workflow_trigger_deploy_command, boolean release_workflow_trigger_deploy_action, boolean invalid_trigger, boolean tested_deploy_action, boolean step_uses_secrets_deploy_action, boolean step_uses_secrets_deploy_command) {
            ...
            this.release_workflow_trigger_deploy_action = release_workflow_trigger_deploy_action;
            this.release_workflow_trigger_deploy_command = release_workflow_trigger_deploy_command;
            this.step_uses_secrets_deploy_action = step_uses_secrets_deploy_action;
            this.step_uses_secrets_deploy_command = step_uses_secrets_deploy_command;
    ...
    public static class AllInputs {
        ...
        /**
          ...
          * @param step_uses_secrets_deploy_command The value to set step_uses_secrets_deploy_command to.
          */
        public AllInputs(boolean deploy_action, boolean deploy_command, boolean deploy_kws, boolean release_workflow_trigger_deploy_command, boolean release_workflow_trigger_deploy_action, boolean invalid_trigger, boolean tested_deploy_action, boolean step_uses_secrets_deploy_action, boolean step_uses_secrets_deploy_command) {
            this.deploy_action = deploy_action;
            this.deploy_command = deploy_command;
            this.deploy_kws = deploy_kws;
            this.release_workflow_trigger_deploy_command = release_workflow_trigger_deploy_command;
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(BuildCheck3 system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(BuildCheck3 system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(BuildCheck3 system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(BuildCheck3 system$model) {
    ...
    public InferredValueOutputs execute(InferValueInputs inputs) {
        ...
        this.release_workflow_trigger_deploy_action.set(inputs.release_workflow_trigger_deploy_action);
        this.release_workflow_trigger_deploy_command.set(inputs.release_workflow_trigger_deploy_command);
        this.step_uses_secrets_deploy_action.set(inputs.step_uses_secrets_deploy_action);
        this.step_uses_secrets_deploy_command.set(inputs.step_uses_secrets_deploy_command);
