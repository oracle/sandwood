...
public class Conditional7 extends GeneratedAPIBuilder {
    @Override
    public CompilationDesc buildClass(CompilationOptions opts) {
        ...
        DoubleVariable value2 = value.add(intVariable(1, location(21, 29, 21, 29)), location(21, 27, 21, 27));
        ...
        return compileAPI(opts, $variableNames, "Conditional7", $helperClasses, "org.sandwood.compiler.tests.parser", $constructorArgs, getOriginalModel(), null);
    }
    ...
    private static String getOriginalModel() {
        return "/*\n"
             ...
             + "package org.sandwood.compiler.tests.parser;\n"
             + "\n"
             + "public model Conditional7(double observedValue, boolean observedGuard)  {\n"
             + "        \n"
