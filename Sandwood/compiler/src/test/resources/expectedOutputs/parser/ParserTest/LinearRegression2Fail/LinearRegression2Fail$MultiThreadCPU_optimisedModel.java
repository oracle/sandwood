...
final class LinearRegression2Fail$MultiThreadCPU extends CoreModelMultiThreadCPU implements LinearRegression2Fail$CoreInterface {
	...
	public LinearRegression2Fail$MultiThreadCPU(ExecutionTarget target) {
		super(target);
	}
