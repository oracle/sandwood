...
class HMMMetrics$SingleThreadCPU extends org.sandwood.runtime.internal.model.CoreModelSingleThreadCPU implements HMMMetrics$CoreInterface {
	...
	private final void sample39(int var35) {
		...
		double[] cv$countLocal = cv$var36$countGlobal;
	...
	public final void forwardGeneration() {
		for(int var35 = 0; var35 < noStates; var35 += 1) {
			...
			if(!fixedFlag$sample39)
				DistributionSampling.sampleDirichlet(RNG$, v, var36);
		}
		if(!fixedFlag$sample46)
		...
		for(int var81 = 0; var81 < noStates; var81 += 1) {
			if(!fixedFlag$sample87)
				cpuMean[var81] = ((Math.sqrt(8.6) * DistributionSampling.sampleGaussian(RNG$)) + 16.0);
		}
		for(int var99 = 0; var99 < noStates; var99 += 1) {
			if(!fixedFlag$sample105)
				memMean[var99] = ((Math.sqrt(1.0) * DistributionSampling.sampleGaussian(RNG$)) + 94.0);
		}
		for(int var117 = 0; var117 < noStates; var117 += 1) {
			if(!fixedFlag$sample123)
				pageFaultsMean[var117] = ((Math.sqrt(335550.0) * DistributionSampling.sampleGaussian(RNG$)) + 814.0);
		}
		for(int var134 = 0; var134 < noStates; var134 += 1) {
			if(!fixedFlag$sample140)
	...
	public final void gibbsRound() {
		if(system$gibbsForward) {
			...
			for(int var168 = (noStates - ((((noStates - 1) - 0) % 1) + 1)); var168 >= ((0 - 1) + 1); var168 -= 1) {
				if(!fixedFlag$sample174)
					sample174(var168);
			}
			for(int var151 = (noStates - ((((noStates - 1) - 0) % 1) + 1)); var151 >= ((0 - 1) + 1); var151 -= 1) {
				if(!fixedFlag$sample157)
					sample157(var151);
			}
			for(int var134 = (noStates - ((((noStates - 1) - 0) % 1) + 1)); var134 >= ((0 - 1) + 1); var134 -= 1) {
				if(!fixedFlag$sample140)
					sample140(var134);
			}
			for(int var117 = (noStates - ((((noStates - 1) - 0) % 1) + 1)); var117 >= ((0 - 1) + 1); var117 -= 1) {
				if(!fixedFlag$sample123)
					sample123(var117);
			}
			for(int var99 = (noStates - ((((noStates - 1) - 0) % 1) + 1)); var99 >= ((0 - 1) + 1); var99 -= 1) {
				if(!fixedFlag$sample105)
					sample105(var99);
			}
			for(int var81 = (noStates - ((((noStates - 1) - 0) % 1) + 1)); var81 >= ((0 - 1) + 1); var81 -= 1) {
				if(!fixedFlag$sample87)
					sample87(var81);
			}
			...
			if(!fixedFlag$sample46)
				sample46();
			for(int var35 = (noStates - ((((noStates - 1) - 0) % 1) + 1)); var35 >= ((0 - 1) + 1); var35 -= 1) {
				if(!fixedFlag$sample39)
					sample39(var35);
			}
		}
