														...
														{
															{
																{
																	{
																		if(((Math.log(1.0) + Math.log((flips[j][var45]?traceTempVariable$var34$2_1:(1.0 - traceTempVariable$var34$2_1)))) < cv$accumulatedConsumerProbabilities))
																			cv$accumulatedConsumerProbabilities = (Math.log((Math.exp(((Math.log(1.0) + Math.log((flips[j][var45]?traceTempVariable$var34$2_1:(1.0 - traceTempVariable$var34$2_1)))) - cv$accumulatedConsumerProbabilities)) + 1)) + cv$accumulatedConsumerProbabilities);
																		else {
																			if((cv$accumulatedConsumerProbabilities == Double.NEGATIVE_INFINITY))
																				cv$accumulatedConsumerProbabilities = (Math.log(1.0) + Math.log((flips[j][var45]?traceTempVariable$var34$2_1:(1.0 - traceTempVariable$var34$2_1))));
																			else
																				cv$accumulatedConsumerProbabilities = (Math.log((Math.exp((cv$accumulatedConsumerProbabilities - (Math.log(1.0) + Math.log((flips[j][var45]?traceTempVariable$var34$2_1:(1.0 - traceTempVariable$var34$2_1)))))) + 1)) + (Math.log(1.0) + Math.log((flips[j][var45]?traceTempVariable$var34$2_1:(1.0 - traceTempVariable$var34$2_1)))));
																		}
