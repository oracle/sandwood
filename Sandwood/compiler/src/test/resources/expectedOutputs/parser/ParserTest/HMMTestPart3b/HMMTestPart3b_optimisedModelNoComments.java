...
/**
  * Class representing the Sandwood model HMMTestPart3b This is the class that
  * all user interactions with the model should occur through.
  */
public class HMMTestPart3b extends Model {

    private HMMTestPart3b$CoreInterface system$c = new HMMTestPart3b$SingleThreadCPU(ExecutionTarget.singleThread);
    ...
    private final ComputedIntegerArrayInternal $st = new ComputedIntegerArrayInternal(this, "st", true) {
        ...
        public Immutability isFixed() {
            ...
            if(fixedFlag$sample53 && fixedFlag$sample75)
                return Immutability.FIXED;
            else if(fixedFlag$sample53 || fixedFlag$sample75)
    ...
    public HMMTestPart3b(int flipsMeasuredShape) {
        this();
    ...
    public HMMTestPart3b(boolean[] flipsMeasured) {
        this();
        this.flipsMeasured.setValue(flipsMeasured);
    }
    
    @Override
    protected HMMTestPart3b$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        HMMTestPart3b$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new HMMTestPart3b$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new HMMTestPart3b$MultiThreadCPU(target);
                break;
            default:
    ...
    private void transferData(HMMTestPart3b$CoreInterface oldCore, HMMTestPart3b$CoreInterface newCore) {
        ...
        if(flips.isSet())
            newCore.set$fixedFlag$sample97(oldCore.get$fixedFlag$sample97());
        if(m.isSet())
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(HMMTestPart3b system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(HMMTestPart3b system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(HMMTestPart3b system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(HMMTestPart3b system$model) {
