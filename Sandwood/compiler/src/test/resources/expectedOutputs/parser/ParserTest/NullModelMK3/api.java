...
public class NullModelMK3 extends GeneratedAPIBuilder {
    @Override
    public CompilationDesc buildClass(CompilationOptions opts) {
        ...
        DoubleVariable bias = uniform(min, doubleVariable(1.0, location(13, 40, 13, 42)), location(13, 23, 13, 43)).sample(location(13, 45, 13, 52));
        bias.setAlias("bias");
        bias.setLocation(location(13, 16, 13, 19));

        Binomial binomial = binomial(bias, observedSampleCount, location(16, 29, 16, 67));
        ...
        return compileAPI(opts, $variableNames, "NullModelMK3", $helperClasses, "org.sandwood.compiler.tests.parser", $constructorArgs, getOriginalModel(), null);
    }
