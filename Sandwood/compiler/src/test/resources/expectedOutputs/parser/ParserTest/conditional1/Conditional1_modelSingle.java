...
/**
  * Class representing the Sandwood model Conditional1 This is the class that
  * all user interactions with the model should occur through.
  */
public class Conditional1 extends Model {
    ...
    @Override
    protected Conditional1$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        Conditional1$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new Conditional1$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new Conditional1$MultiThreadCPU(target);
                break;
            default:
