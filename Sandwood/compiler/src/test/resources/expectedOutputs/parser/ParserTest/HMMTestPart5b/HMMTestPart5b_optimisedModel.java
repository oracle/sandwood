...
/**
 * Class representing the Sandwood model HMMTestPart5b This is the class that all
 * user interactions with the model should occur through.
 */
public final class HMMTestPart5b extends Model {
    ...
    private final ComputedIntegerArrayInternal $st = new ComputedIntegerArrayInternal(this, "st", true, true, false, ProbabilityType.UNSKIPPABLE) {
        ...
        public void setFixed(boolean fixed) {
            synchronized(model) {
                ...
                system$c.set$fixedFlag$sample76(fixed, allocated);
            }
        }
        ...
        public Immutability isFixed() {
            ...
            if(fixedFlag$sample53 && fixedFlag$sample76)
                return Immutability.FIXED;
            else if(fixedFlag$sample53 || fixedFlag$sample76)
    ...
    private void transferData(HMMTestPart5b$CoreInterface oldCore, HMMTestPart5b$CoreInterface newCore) {
        ...
        newCore.set$fixedFlag$sample76(oldCore.get$fixedFlag$sample76(), false);
    }
