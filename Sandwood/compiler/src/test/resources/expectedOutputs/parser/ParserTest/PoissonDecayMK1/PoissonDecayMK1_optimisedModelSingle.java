...
public class PoissonDecayMK1 extends Model {
    ...
    private final ObservedIntegerArrayShapeableInternal $decayDetected = new ObservedIntegerArrayShapeableInternal(this, "decayDetected") {
        @Override
        public int[] getValue() {
            synchronized(model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(PoissonDecayMK1 system$model) {
            ...
            this.poisson = system$model.poisson.getLogProbability();
    ...
    public static class Probabilities {
        ...
        Probabilities(PoissonDecayMK1 system$model) {
            ...
            this.poisson = system$model.poisson.getProbability();
