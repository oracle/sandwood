		...
		for(int t$var59 = 0; t$var59 < T; t$var59 += 1) {
			for(int j$var88 = 0; j$var88 <= noProducts; j$var88 += 1) {
				...
				if(!guard$sample25put94$global[t$var59][j$var88]) {
					...
					for(int cv$reduction829Index = 0; cv$reduction829Index <= noProducts; cv$reduction829Index += 1)
						...
						reduceVar$denom$10 = (reduceVar$denom$10 + weekly_ut[t$var59][cv$reduction829Index]);
			...
			for(int t$var59 = 0; t$var59 < T; t$var59 += 1) {
				for(int j$var88 = 0; j$var88 <= noProducts; j$var88 += 1) {
					...
					if(!guard$sample25put94$global[t$var59][j$var88]) {
						...
						// For each index in the array to be reduced
						for(int cv$reduction1028Index = 0; cv$reduction1028Index <= noProducts; cv$reduction1028Index += 1)
							// Execute the reduction function, saving the result into the return value.
							// 
							// Copy the result of the reduction into the variable returned by the reduction.
							// 
							// l's comment
							// Set the right hand term to a value from the array weekly_ut
							reduceVar$denom$13 = (reduceVar$denom$13 + weekly_ut[t$var59][cv$reduction1028Index]);
