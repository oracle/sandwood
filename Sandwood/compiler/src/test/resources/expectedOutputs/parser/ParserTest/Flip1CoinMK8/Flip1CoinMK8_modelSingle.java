 ...
 */
public final class Flip1CoinMK8 extends Model<Flip1CoinMK8.State> {
	final class State extends CoreModelState {
		...
		final void set$fixedFlag$sample7(boolean cv$value, boolean allocated$) {
			...
			// the flag to false.
			fixedProbFlag$sample20 = (fixedFlag$sample7 && fixedProbFlag$sample20);
		}
    ...
    public Flip1CoinMK8() {
        ...
        Flip1CoinMK8$SingleThreadCPU core = new Flip1CoinMK8$SingleThreadCPU(state, ExecutionTarget.singleThread);
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new Flip1CoinMK8$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new Flip1CoinMK8$MultiThreadCPU(state, target);
            default:
