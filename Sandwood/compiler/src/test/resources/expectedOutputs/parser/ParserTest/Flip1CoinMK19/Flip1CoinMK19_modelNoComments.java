...
public class Flip1CoinMK19 extends Model {
    ...
    private final ComputedObjectArrayInternal<double[]> $bias = new ComputedObjectArrayInternal<double[]>(this, "bias", false, org.sandwood.runtime.internal.model.util.BaseType.DOUBLE, 2) {
        ...
        public Immutability isFixed() {
            ...
            if(fixedFlag$sample13 && fixedFlag$sample19)
                return Immutability.FIXED;
            else if(fixedFlag$sample13 || fixedFlag$sample19)
    ...
    @Override
    protected Flip1CoinMK19$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        Flip1CoinMK19$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new Flip1CoinMK19$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new Flip1CoinMK19$MultiThreadCPU(target);
                break;
            default:
