...
/**
 * Class representing the Sandwood model Flip1CoinMK4 This is the class that all user
 * interactions with the model should occur through.
 */
public final class Flip1CoinMK4 extends Model<Flip1CoinMK4.State> {
...
double bias;
    ...
    public Flip1CoinMK4() {
        ...
        Flip1CoinMK4$SingleThreadCPU core = new Flip1CoinMK4$SingleThreadCPU(state, ExecutionTarget.singleThread);
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new Flip1CoinMK4$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new Flip1CoinMK4$MultiThreadCPU(state, target);
            default:
