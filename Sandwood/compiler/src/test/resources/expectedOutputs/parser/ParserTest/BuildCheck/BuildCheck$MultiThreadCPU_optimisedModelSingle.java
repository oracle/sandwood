	...
	private final void logProbabilityValue$sample21() {
		...
		if(!fixedProbFlag$sample21) {
			...
			if(deploy_action)
				...
				// 
				// The sample value to calculate the probability of generating
				calculationVariable$sampleAccumulator = org.sandwood.runtime.internal.numericTools.DistributionSampling.logProbabilityBernoulli(var19, 0.8);
		...
		// Using cached values.
			...
			if(deploy_action)
				...
				// 
				// Variable declaration of calculationVariable$accumulator moved.
				logProbability$deploy_action_certainty = (logProbability$deploy_action_certainty + logProbability$var19);
	...
	private final void logProbabilityValue$sample28() {
		...
		if(!fixedProbFlag$sample28) {
			...
			if(tested_deploy_action)
				...
				// 
				// The sample value to calculate the probability of generating
				calculationVariable$sampleAccumulator = org.sandwood.runtime.internal.numericTools.DistributionSampling.logProbabilityBernoulli(var24, 0.1);
			...
			// 
			// Accumulator for probabilities of instances of the random variable
			logProbability$var24 = calculationVariable$sampleAccumulator;
		...
		// Using cached values.
			...
			if(tested_deploy_action)
				...
				// 
				// Variable declaration of calculationVariable$accumulator moved.
				logProbability$deploy_action_certainty = (logProbability$deploy_action_certainty + logProbability$var24);
	...
	private final void logProbabilityValue$sample36() {
		...
		if(!fixedProbFlag$sample36) {
			...
			if(release_workflow_trigger_deploy_action)
				...
				// 
				// The sample value to calculate the probability of generating
				calculationVariable$sampleAccumulator = org.sandwood.runtime.internal.numericTools.DistributionSampling.logProbabilityBernoulli(var30, 0.85);
		...
		// Using cached values.
			...
			if(release_workflow_trigger_deploy_action)
				...
				// 
				// Variable declaration of calculationVariable$accumulator moved.
				logProbability$deploy_action_certainty = (logProbability$deploy_action_certainty + logProbability$var30);
	...
	private final void logProbabilityValue$sample44() {
		...
		if(!fixedProbFlag$sample44) {
			...
			if(step_uses_secrets_deploy_action)
				...
				// 
				// The sample value to calculate the probability of generating
				calculationVariable$sampleAccumulator = org.sandwood.runtime.internal.numericTools.DistributionSampling.logProbabilityBernoulli(var36, 0.65);
	...
	private final void logProbabilityValue$sample58() {
		...
		if(!fixedProbFlag$sample58) {
			...
			if(deploy_command)
				...
				// 
				// The sample value to calculate the probability of generating
				calculationVariable$sampleAccumulator = org.sandwood.runtime.internal.numericTools.DistributionSampling.logProbabilityBernoulli(var48, 0.75);
			...
			// 
			// Accumulator for probabilities of instances of the random variable
			logProbability$var48 = calculationVariable$sampleAccumulator;
		...
		// Using cached values.
			...
			if(deploy_command)
				...
				// 
				// Variable declaration of calculationVariable$accumulator moved.
				logProbability$deploy_command_certainty = (logProbability$deploy_command_certainty + logProbability$var48);
	...
	private final void logProbabilityValue$sample65() {
		...
		if(!fixedProbFlag$sample65) {
			...
			if(release_workflow_trigger_deploy_command)
				...
				// 
				// The sample value to calculate the probability of generating
				calculationVariable$sampleAccumulator = org.sandwood.runtime.internal.numericTools.DistributionSampling.logProbabilityBernoulli(var53, 0.85);
			...
			// 
			// Accumulator for probabilities of instances of the random variable
			logProbability$var53 = calculationVariable$sampleAccumulator;
		...
		// Using cached values.
			...
			if(release_workflow_trigger_deploy_command)
				...
				// 
				// Variable declaration of calculationVariable$accumulator moved.
				logProbability$deploy_command_certainty = (logProbability$deploy_command_certainty + logProbability$var53);
	...
	private final void logProbabilityValue$sample73() {
		...
		if(!fixedProbFlag$sample73) {
			...
			if(step_uses_secrets_deploy_command)
				...
				// 
				// The sample value to calculate the probability of generating
				calculationVariable$sampleAccumulator = org.sandwood.runtime.internal.numericTools.DistributionSampling.logProbabilityBernoulli(var59, 0.65);
			...
			// 
			// Accumulator for probabilities of instances of the random variable
			logProbability$var59 = calculationVariable$sampleAccumulator;
		...
		// Using cached values.
			...
			// Updating random variable and model probabilities using cached probabilities for
			// this sample
			logProbability$var58 = logProbability$var59;
			...
			if(step_uses_secrets_deploy_command)
				...
				// 
				// Variable declaration of calculationVariable$accumulator moved.
				logProbability$deploy_command_certainty = (logProbability$deploy_command_certainty + logProbability$var59);
	...
	private final void logProbabilityValue$sample83() {
		...
		if(!fixedProbFlag$sample83) {
			...
			if(deploy_kws)
				...
				// 
				// The sample value to calculate the probability of generating
				calculationVariable$sampleAccumulator = org.sandwood.runtime.internal.numericTools.DistributionSampling.logProbabilityBernoulli(var67, 0.7);
		...
		// Using cached values.
			...
			if(deploy_kws)
				...
				// 
				// Variable declaration of calculationVariable$accumulator moved.
				logProbability$deploy_kws_certainty = (logProbability$deploy_kws_certainty + logProbability$var67);
