...
/**
  * Class representing the Sandwood model LinearRegressionWrongNameFail This is the class that
  * all user interactions with the model should occur through.
  */
public final class LinearRegressionWrongNameFail extends Model {
    ...
    @Override
    protected LinearRegressionWrongNameFail$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        LinearRegressionWrongNameFail$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new LinearRegressionWrongNameFail$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new LinearRegressionWrongNameFail$MultiThreadCPU(target);
                break;
            default:
