...
/**
 * Class representing the Sandwood model LinearRegressionWrongNameFail This is the
 * class that all user interactions with the model should occur through.
 */
public final class LinearRegressionWrongNameFail extends Model<LinearRegressionWrongNameFail.State> {
    ...
    public LinearRegressionWrongNameFail() {
        super();
        state = new State();
        //ComputedVariable
        ...
        LinearRegressionWrongNameFail$SingleThreadCPU core = new LinearRegressionWrongNameFail$SingleThreadCPU(state, ExecutionTarget.singleThread);
	 ...
	 */
    public LinearRegressionWrongNameFail(double[] x) {
        this();
        this.$x.setValue(x);
    }
	 ...
	 */
    public LinearRegressionWrongNameFail(double[] x, double[] yMeasured) {
        this();
        this.x.setValue(x);
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new LinearRegressionWrongNameFail$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new LinearRegressionWrongNameFail$MultiThreadCPU(state, target);
            default:
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(LinearRegressionWrongNameFail system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(LinearRegressionWrongNameFail system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(LinearRegressionWrongNameFail system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(LinearRegressionWrongNameFail system$model) {
