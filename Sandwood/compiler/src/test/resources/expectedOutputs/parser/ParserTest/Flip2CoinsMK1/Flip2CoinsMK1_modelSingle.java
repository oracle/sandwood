...
/**
 * Class representing the Sandwood model Flip2CoinsMK1 This is the class that all
 * user interactions with the model should occur through.
 */
public final class Flip2CoinsMK1 extends Model {
    private Flip2CoinsMK1$CoreInterface system$c = new Flip2CoinsMK1$SingleThreadCPU(ExecutionTarget.singleThread);
	 ...
	 */
    public Flip2CoinsMK1(int[] flipsMeasuredShape) {
        this();
	 ...
	 */
    public Flip2CoinsMK1(boolean[][] flipsMeasured) {
        this();
        this.flipsMeasured.setValue(flipsMeasured);
    }
    
    @Override
    protected Flip2CoinsMK1$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        Flip2CoinsMK1$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new Flip2CoinsMK1$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new Flip2CoinsMK1$MultiThreadCPU(target);
                break;
            default:
    ...
    private void transferData(Flip2CoinsMK1$CoreInterface oldCore, Flip2CoinsMK1$CoreInterface newCore) {
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(Flip2CoinsMK1 system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(Flip2CoinsMK1 system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(Flip2CoinsMK1 system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(Flip2CoinsMK1 system$model) {
