 ...
 */
public final class Flip2CoinsMK1 extends Model<Flip2CoinsMK1.State> {
    ...
    public Flip2CoinsMK1() {
        ...
        Flip2CoinsMK1$SingleThreadCPU core = new Flip2CoinsMK1$SingleThreadCPU(state, ExecutionTarget.singleThread);
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new Flip2CoinsMK1$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new Flip2CoinsMK1$MultiThreadCPU(state, target);
            default:
