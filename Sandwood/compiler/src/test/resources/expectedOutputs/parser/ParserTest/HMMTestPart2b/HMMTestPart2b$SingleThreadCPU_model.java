...
import org.sandwood.compiler.tests.parser.HMMTestPart2b$SingleThreadCPU.Scratch;
import org.sandwood.compiler.tests.parser.HMMTestPart2b.State;
...
final class HMMTestPart2b$SingleThreadCPU extends CoreModelSingleThreadCPU<State, Scratch> {
	...
	public HMMTestPart2b$SingleThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
	...
	private final void drawValueSample71(int i$var64) {
		state.st[(i$var64 + 1)] = DistributionSampling.sampleCategorical(state.RNG$, state.m[state.st[i$var64]], state.states);
	}
		...
		if(true) {
				...
				cv$countLocal[cv$loopIndex] = 0.0;
			{
				// Processing random variable 69.
				{
					...
					{
						{
							for(int i$var64 = 0; i$var64 < (state.samples - 1); i$var64 += 1) {
								if((var27 == state.st[i$var64])) {
									// Processing sample task 71 of consumer random variable null.
									{
										{
											// Flag recording if this sample task of the consuming random variable is constrained.
											boolean cv$sampleConstrained = (state.fixedFlag$sample71 || state.constrainedFlag$sample71[((i$var64 - 0) / 1)]);
															...
															{
																{
																	...
																	// variable var69
																	cv$countLocal[state.st[(i$var64 + 1)]] = (cv$countLocal[state.st[(i$var64 + 1)]] + 1.0);
																}
															}
														}
													}
	...
	private final void inferSample71(int i$var64) {
		if(true) {
			state.constrainedFlag$sample71[((i$var64 - 0) / 1)] = false;
			...
			for(int cv$valuePos = 0; cv$valuePos < cv$numStates; cv$valuePos += 1) {
				...
				// Guards to ensure that st is only updated when there is a valid path.
				{
					{
						{
							state.st[(i$var64 + 1)] = cv$currentValue;
						}
					}
				}
				{
					...
					double[] var68 = state.m[state.st[i$var64]];
						...
						{
							{
								...
								for(int index$i$2_2 = 0; index$i$2_2 < (state.samples - 1); index$i$2_2 += 1) {
									if(((i$var64 + 1) == index$i$2_2)) {
										// Processing sample task 71 of consumer random variable null.
										{
											{
												// Flag recording if this sample task of the consuming random variable is constrained.
												boolean cv$sampleConstrained = (state.fixedFlag$sample71 || state.constrainedFlag$sample71[((index$i$2_2 - 0) / 1)]);
												if(cv$sampleConstrained) {
													// Mark that the sample has observed constrained data.
													state.constrainedFlag$sample71[((i$var64 - 0) / 1)] = true;
																...
																{
																	{
																		...
																		if(((Math.log(1.0) + ((((((0.0 <= state.st[(index$i$2_2 + 1)]) && (state.st[(index$i$2_2 + 1)] < state.states)) && (0 < state.states)) && (0.0 <= sc$var68$1[state.st[(index$i$2_2 + 1)]])) && (sc$var68$1[state.st[(index$i$2_2 + 1)]] <= 1.0))?Math.log(sc$var68$1[state.st[(index$i$2_2 + 1)]]):Double.NEGATIVE_INFINITY)) < cv$accumulatedConsumerProbabilities))
																			cv$accumulatedConsumerProbabilities = (Math.log((Math.exp(((Math.log(1.0) + ((((((0.0 <= state.st[(index$i$2_2 + 1)]) && (state.st[(index$i$2_2 + 1)] < state.states)) && (0 < state.states)) && (0.0 <= sc$var68$1[state.st[(index$i$2_2 + 1)]])) && (sc$var68$1[state.st[(index$i$2_2 + 1)]] <= 1.0))?Math.log(sc$var68$1[state.st[(index$i$2_2 + 1)]]):Double.NEGATIVE_INFINITY)) - cv$accumulatedConsumerProbabilities)) + 1)) + cv$accumulatedConsumerProbabilities);
																		else {
																			// If the second value is -infinity.
																			if((cv$accumulatedConsumerProbabilities == Double.NEGATIVE_INFINITY))
																				cv$accumulatedConsumerProbabilities = (Math.log(1.0) + ((((((0.0 <= state.st[(index$i$2_2 + 1)]) && (state.st[(index$i$2_2 + 1)] < state.states)) && (0 < state.states)) && (0.0 <= sc$var68$1[state.st[(index$i$2_2 + 1)]])) && (sc$var68$1[state.st[(index$i$2_2 + 1)]] <= 1.0))?Math.log(sc$var68$1[state.st[(index$i$2_2 + 1)]]):Double.NEGATIVE_INFINITY));
																			else
																				cv$accumulatedConsumerProbabilities = (Math.log((Math.exp((cv$accumulatedConsumerProbabilities - (Math.log(1.0) + ((((((0.0 <= state.st[(index$i$2_2 + 1)]) && (state.st[(index$i$2_2 + 1)] < state.states)) && (0 < state.states)) && (0.0 <= sc$var68$1[state.st[(index$i$2_2 + 1)]])) && (sc$var68$1[state.st[(index$i$2_2 + 1)]] <= 1.0))?Math.log(sc$var68$1[state.st[(index$i$2_2 + 1)]]):Double.NEGATIVE_INFINITY)))) + 1)) + (Math.log(1.0) + ((((((0.0 <= state.st[(index$i$2_2 + 1)]) && (state.st[(index$i$2_2 + 1)] < state.states)) && (0 < state.states)) && (0.0 <= sc$var68$1[state.st[(index$i$2_2 + 1)]])) && (sc$var68$1[state.st[(index$i$2_2 + 1)]] <= 1.0))?Math.log(sc$var68$1[state.st[(index$i$2_2 + 1)]]):Double.NEGATIVE_INFINITY)));
																		}
					...
					// Processing random variable 84.
					{
						...
						{
							{
								int traceTempVariable$var82$5_1 = cv$currentValue;
								for(int j = 1; j < state.samples; j += 1) {
									if(((i$var64 + 1) == j)) {
										// Processing sample task 86 of consumer random variable null.
										{
															...
															{
																{
																	{
																		// Constructing a random variable input for use later.
																		double var83 = state.bias[traceTempVariable$var82$5_1];
																		
																		// Record the probability of sample task 86 generating output with current configuration.
																		if(((Math.log(1.0) + (((0.0 <= var83) && (var83 <= 1.0))?Math.log((state.flips[j]?var83:(1.0 - var83))):Double.NEGATIVE_INFINITY)) < cv$accumulatedConsumerProbabilities))
																			cv$accumulatedConsumerProbabilities = (Math.log((Math.exp(((Math.log(1.0) + (((0.0 <= var83) && (var83 <= 1.0))?Math.log((state.flips[j]?var83:(1.0 - var83))):Double.NEGATIVE_INFINITY)) - cv$accumulatedConsumerProbabilities)) + 1)) + cv$accumulatedConsumerProbabilities);
																		else {
																			// If the second value is -infinity.
																			if((cv$accumulatedConsumerProbabilities == Double.NEGATIVE_INFINITY))
																				cv$accumulatedConsumerProbabilities = (Math.log(1.0) + (((0.0 <= var83) && (var83 <= 1.0))?Math.log((state.flips[j]?var83:(1.0 - var83))):Double.NEGATIVE_INFINITY));
																			else
																				cv$accumulatedConsumerProbabilities = (Math.log((Math.exp((cv$accumulatedConsumerProbabilities - (Math.log(1.0) + (((0.0 <= var83) && (var83 <= 1.0))?Math.log((state.flips[j]?var83:(1.0 - var83))):Double.NEGATIVE_INFINITY)))) + 1)) + (Math.log(1.0) + (((0.0 <= var83) && (var83 <= 1.0))?Math.log((state.flips[j]?var83:(1.0 - var83))):Double.NEGATIVE_INFINITY)));
																		}
			...
			if(state.constrainedFlag$sample71[((i$var64 - 0) / 1)]) {
		...
		if(!state.fixedProbFlag$sample71) {
			...
			for(int i$var64 = 0; i$var64 < (state.samples - 1); i$var64 += 1) {
				...
				double cv$probabilityReached = 0.0;
				{
					{
						// The sample value to calculate the probability of generating
						int cv$sampleValue = state.st[(i$var64 + 1)];
						{
							{
								double[] var68 = state.m[state.st[i$var64]];
				...
				state.logProbability$sample71[((i$var64 - 0) / 1)] = cv$sampleProbability;
			}
			...
			// Now the probability is calculated store if it can be cached or if it needs to be
			// recalculated next time.
			state.fixedProbFlag$sample71 = (state.fixedFlag$sample71 && state.fixedFlag$sample28);
		} else {
			// Using cached values.
			// 
			// Updating random variable and model probabilities using cached probabilities for
			...
			for(int i$var64 = 0; i$var64 < (state.samples - 1); i$var64 += 1) {
				double cv$rvAccumulator = 0.0;
				double cv$sampleValue = state.logProbability$sample71[((i$var64 - 0) / 1)];
				cv$rvAccumulator = (cv$rvAccumulator + cv$sampleValue);
	...
	private final void logProbabilityValue$sample86() {
		...
		// just use cached values.
		if(!state.fixedProbFlag$sample86) {
			// Generating probabilities for sample task
			// Accumulator for probabilities of instances of the random variable
			double cv$accumulator = 0.0;
			...
			for(int j = 1; j < state.samples; j += 1) {
				...
				{
					{
						...
						{
							{
								double var83 = state.bias[state.st[j]];
				...
				// Store the sample task probability
				state.logProbability$sample86[((j - 1) / 1)] = cv$sampleProbability;
			}
			...
			// Now the probability is calculated store if it can be cached or if it needs to be
			// recalculated next time.
			state.fixedProbFlag$sample86 = (state.fixedFlag$sample45 && state.fixedFlag$sample71);
		} else {
			// Using cached values.
			// 
			// Updating random variable and model probabilities using cached probabilities for
			...
			for(int j = 1; j < state.samples; j += 1) {
				double cv$rvAccumulator = 0.0;
				double cv$sampleValue = state.logProbability$sample86[((j - 1) / 1)];
				cv$rvAccumulator = (cv$rvAccumulator + cv$sampleValue);
	...
	public final void gibbsRound() {
		...
		// Infer the samples in reverse chronological order.
			...
			for(int i$var64 = ((state.samples - 1) - (((((state.samples - 1) - 1) - 0) % 1) + 1)); i$var64 >= ((0 - 1) + 1); i$var64 -= 1) {
				if(!state.fixedFlag$sample71)
					inferSample71(i$var64);
			}
	...
	private final void initializeLogProbabilityFields() {
		...
		if(!state.fixedProbFlag$sample71) {
			for(int i$var64 = 0; i$var64 < (state.samples - 1); i$var64 += 1)
				state.logProbability$sample71[((i$var64 - 0) / 1)] = Double.NaN;
		}
		state.logProbability$flips = 0.0;
		if(!state.fixedProbFlag$sample86) {
			for(int j = 1; j < state.samples; j += 1)
				state.logProbability$sample86[((j - 1) / 1)] = Double.NaN;
		}
	}
