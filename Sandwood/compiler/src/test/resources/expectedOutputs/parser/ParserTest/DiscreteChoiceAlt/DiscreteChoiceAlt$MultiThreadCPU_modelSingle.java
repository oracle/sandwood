										...
										if((i$var18 == i$var36)) {
											...
											if(((0 <= i$var36) && (i$var36 < noProducts))) {
												if((0 < noProducts)) {
													...
													for(int cv$reduction657Index = 0; cv$reduction657Index < i$var36; cv$reduction657Index += 1) {
														// Set the left hand term of the reduction function to the return variable value.
														double i$var47 = reduceVar$sum$10;
														
														// Set the right hand term to a value from the array exped
														double j = exped[cv$reduction657Index];
													...
													for(int cv$reduction657Index = (i$var36 + 1); cv$reduction657Index < noProducts; cv$reduction657Index += 1) {
														// Set the left hand term of the reduction function to the return variable value.
														double i$var47 = reduceVar$sum$10;
