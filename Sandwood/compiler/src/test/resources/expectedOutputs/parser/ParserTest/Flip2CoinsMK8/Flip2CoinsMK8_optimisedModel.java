 ...
 */
public final class Flip2CoinsMK8 extends Model<Flip2CoinsMK8.State> {
    ...
    public Flip2CoinsMK8() {
        ...
        Flip2CoinsMK8$SingleThreadCPU core = new Flip2CoinsMK8$SingleThreadCPU(state, ExecutionTarget.singleThread);
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new Flip2CoinsMK8$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new Flip2CoinsMK8$MultiThreadCPU(state, target);
            default:
