...
public class LinearRegressionBasic extends GeneratedAPIBuilder {
    @Override
    public CompilationDesc buildClass(CompilationOptions opts) {
        //Allocating initial observed parameters
        ArrayVariable<DoubleVariable> x = observeArray("x", VariableType.arrayType(VariableType.DoubleVariable), location(11, 36, 11, 45));
        ArrayVariable<DoubleVariable> yMeasured = observeArray("yMeasured", VariableType.arrayType(VariableType.DoubleVariable), location(11, 48, 11, 65));
        ...
        DoubleVariable variance = inverseGamma(doubleVariable(1.0, location(16, 40, 16, 42)), doubleVariable(1.0, location(16, 45, 16, 47)), location(16, 27, 16, 48)).sample(location(16, 50, 16, 57));
        ...
        return compileAPI(opts, $variableNames, "LinearRegressionBasic", $helperClasses, "org.sandwood.compiler.tests.parser", $constructorArgs, getOriginalModel(), null);
    }
