...
import org.sandwood.compiler.tests.parser.Flip1CoinMK4$SingleThreadCPU.Scratch;
import org.sandwood.compiler.tests.parser.Flip1CoinMK4.State;
...
final class Flip1CoinMK4$SingleThreadCPU extends CoreModelSingleThreadCPU<State, Scratch> {
	...
	public Flip1CoinMK4$SingleThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
	...
	public final void propagateObservedValues() {
		for(int i = ((0 - 1) + ((((state.samples - 1) - ((0 - 1) + 1)) % 1) + 1)); i < state.samples; i += 1)
