...
class HMMTestPart5b$MultiThreadCPU extends org.sandwood.runtime.internal.model.CoreModelMultiThreadCPU implements HMMTestPart5b$CoreInterface {
	...
	public final void set$flips(boolean[] cv$value) {
		...
		// Unset the fixed probability flag for sample 99 as it depends on flips.
		fixedProbFlag$sample99 = false;
	}
	...
	private final void logProbabilityValue$sample99() {
		...
		if(!fixedProbFlag$sample99) {
			...
			// Now the probability is calculated store if it can be cached or if it needs to be
			// recalculated next time.
			fixedProbFlag$sample99 = (((fixedFlag$sample99 && fixedFlag$sample45) && fixedFlag$sample53) && fixedFlag$sample76);
		}
		// Using cached values.
		else {
			// Updating random variable and model probabilities using cached probabilities for
		...
		for(int cv$valuePos = 0; cv$valuePos < cv$numNumStates; cv$valuePos += 1) {
			...
			st[0] = (states * cv$currentValue);
			{
				...
				// Processing random variable 74.
				{
					...
					{
						int traceTempVariable$var72$1_1 = (states * cv$currentValue);
						for(int i$var67 = 4; i$var67 < (samples + 3); i$var67 += 1) {
							if((0 == (i$var67 - 4))) {
								// Processing sample task 76 of consumer random variable null.
								{
											...
											{
												{
													...
													if(((Math.log(1.0) + (((0.0 <= (st[(i$var67 - 3)] / states)) && ((st[(i$var67 - 3)] / states) < cv$temp$3$$var329))?Math.log(cv$temp$2$var73[(st[(i$var67 - 3)] / states)]):Double.NEGATIVE_INFINITY)) < cv$accumulatedConsumerProbabilities))
														cv$accumulatedConsumerProbabilities = (Math.log((Math.exp(((Math.log(1.0) + (((0.0 <= (st[(i$var67 - 3)] / states)) && ((st[(i$var67 - 3)] / states) < cv$temp$3$$var329))?Math.log(cv$temp$2$var73[(st[(i$var67 - 3)] / states)]):Double.NEGATIVE_INFINITY)) - cv$accumulatedConsumerProbabilities)) + 1)) + cv$accumulatedConsumerProbabilities);
													else {
														// If the second value is -infinity.
														if((cv$accumulatedConsumerProbabilities == Double.NEGATIVE_INFINITY))
															cv$accumulatedConsumerProbabilities = (Math.log(1.0) + (((0.0 <= (st[(i$var67 - 3)] / states)) && ((st[(i$var67 - 3)] / states) < cv$temp$3$$var329))?Math.log(cv$temp$2$var73[(st[(i$var67 - 3)] / states)]):Double.NEGATIVE_INFINITY));
														else
															cv$accumulatedConsumerProbabilities = (Math.log((Math.exp((cv$accumulatedConsumerProbabilities - (Math.log(1.0) + (((0.0 <= (st[(i$var67 - 3)] / states)) && ((st[(i$var67 - 3)] / states) < cv$temp$3$$var329))?Math.log(cv$temp$2$var73[(st[(i$var67 - 3)] / states)]):Double.NEGATIVE_INFINITY)))) + 1)) + (Math.log(1.0) + (((0.0 <= (st[(i$var67 - 3)] / states)) && ((st[(i$var67 - 3)] / states) < cv$temp$3$$var329))?Math.log(cv$temp$2$var73[(st[(i$var67 - 3)] / states)]):Double.NEGATIVE_INFINITY)));
													}
				...
				// Processing random variable 97.
				{
					...
					{
						int traceTempVariable$var95$4_1 = (states * cv$currentValue);
						for(int j = 5; j < (samples + 5); j += 1) {
							if((0 == (j - 5))) {
								// Processing sample task 99 of consumer random variable null.
								{
	...
	private final void sample76(int i$var67) {
		...
		for(int cv$valuePos = 0; cv$valuePos < cv$numNumStates; cv$valuePos += 1) {
			...
			st[(i$var67 - 3)] = (states * cv$currentValue);
			{
				...
				// An accumulator to allow the value for each distribution to be constructed before
				// it is added to the index probabilities.
				double cv$accumulatedProbabilities = (Math.log(1.0) + (((0.0 <= cv$currentValue) && (cv$currentValue < cv$temp$1$$var351))?Math.log(cv$temp$0$var73[cv$currentValue]):Double.NEGATIVE_INFINITY));
											...
											{
												{
													...
													// Record the probability of sample task 76 generating output with current configuration.
													if(((Math.log(1.0) + (((0.0 <= (st[(index$i$1_2 - 3)] / states)) && ((st[(index$i$1_2 - 3)] / states) < cv$temp$3$$var360))?Math.log(cv$temp$2$var73[(st[(index$i$1_2 - 3)] / states)]):Double.NEGATIVE_INFINITY)) < cv$accumulatedConsumerProbabilities))
														cv$accumulatedConsumerProbabilities = (Math.log((Math.exp(((Math.log(1.0) + (((0.0 <= (st[(index$i$1_2 - 3)] / states)) && ((st[(index$i$1_2 - 3)] / states) < cv$temp$3$$var360))?Math.log(cv$temp$2$var73[(st[(index$i$1_2 - 3)] / states)]):Double.NEGATIVE_INFINITY)) - cv$accumulatedConsumerProbabilities)) + 1)) + cv$accumulatedConsumerProbabilities);
													else {
														// If the second value is -infinity.
														if((cv$accumulatedConsumerProbabilities == Double.NEGATIVE_INFINITY))
															cv$accumulatedConsumerProbabilities = (Math.log(1.0) + (((0.0 <= (st[(index$i$1_2 - 3)] / states)) && ((st[(index$i$1_2 - 3)] / states) < cv$temp$3$$var360))?Math.log(cv$temp$2$var73[(st[(index$i$1_2 - 3)] / states)]):Double.NEGATIVE_INFINITY));
														else
															cv$accumulatedConsumerProbabilities = (Math.log((Math.exp((cv$accumulatedConsumerProbabilities - (Math.log(1.0) + (((0.0 <= (st[(index$i$1_2 - 3)] / states)) && ((st[(index$i$1_2 - 3)] / states) < cv$temp$3$$var360))?Math.log(cv$temp$2$var73[(st[(index$i$1_2 - 3)] / states)]):Double.NEGATIVE_INFINITY)))) + 1)) + (Math.log(1.0) + (((0.0 <= (st[(index$i$1_2 - 3)] / states)) && ((st[(index$i$1_2 - 3)] / states) < cv$temp$3$$var360))?Math.log(cv$temp$2$var73[(st[(index$i$1_2 - 3)] / states)]):Double.NEGATIVE_INFINITY)));
													}
