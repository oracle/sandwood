...
final class NoisyOr$SingleThreadCPU extends org.sandwood.runtime.internal.model.CoreModelSingleThreadCPU implements NoisyOr$CoreInterface {
	...
	private final void logProbabilityValue$sample233() {
		...
		if(!fixedProbFlag$sample233) {
			...
			// 
			// Accumulator for probabilities of instances of the random variable
			logProbability$issues$var213 = (logProbability$issues$var213 + cv$sampleAccumulator);
			...
			// Update the variable probability
			logProbability$issues$var213 = (logProbability$issues$var213 + cv$rvAccumulator);
	...
	private final void logProbabilityValue$sample430() {
		...
		if(!fixedProbFlag$sample430) {
			...
			// 
			// Accumulator for probabilities of instances of the random variable
			logProbability$issues$var383 = (logProbability$issues$var383 + cv$sampleAccumulator);
			...
			// Update the variable probability
			logProbability$issues$var383 = (logProbability$issues$var383 + cv$rvAccumulator);
