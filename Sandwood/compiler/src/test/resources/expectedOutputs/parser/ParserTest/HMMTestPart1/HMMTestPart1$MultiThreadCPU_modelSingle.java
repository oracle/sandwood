...
import org.sandwood.compiler.tests.parser.HMMTestPart1$MultiThreadCPU.Scratch;
...
final class HMMTestPart1$MultiThreadCPU extends CoreModelMultiThreadCPU<State, Scratch> {
	...
	public HMMTestPart1$MultiThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
