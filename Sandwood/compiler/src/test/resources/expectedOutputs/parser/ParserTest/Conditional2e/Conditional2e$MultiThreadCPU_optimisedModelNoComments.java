...
import org.sandwood.compiler.tests.parser.Conditional2e$MultiThreadCPU.Scratch;
...
final class Conditional2e$MultiThreadCPU extends CoreModelMultiThreadCPU<State, Scratch> {
...
double[] cv$var4$stateProbabilityGlobal;
	...
	public Conditional2e$MultiThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
