...
class BuildCheck2$SingleThreadCPU extends org.sandwood.runtime.internal.model.CoreModelSingleThreadCPU implements BuildCheck2$CoreInterface {
	...
	public BuildCheck2$SingleThreadCPU(ExecutionTarget target) {
		super(target);
	}
