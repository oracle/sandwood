...
public class Flip1CoinMK12 extends Model {
    ...
    private final ComputedDoubleInternal $bias = new ComputedDoubleInternal(this, "bias", false) {
        ...
        public Immutability isFixed() {
            ...
            boolean fixedFlag$sample39 = system$c.get$fixedFlag$sample39();
            if(fixedFlag$sample20 && fixedFlag$sample32 && fixedFlag$sample39)
                return Immutability.FIXED;
            else if(fixedFlag$sample20 || fixedFlag$sample32 || fixedFlag$sample39)
    ...
    private final ObservedIntegerInternal $guard2 = new ObservedIntegerInternal(this, "guard2") {
        ...
        @Override
        protected void setValueInternal(int value) { system$c.set$guard2(value); }
    };
