...
import org.sandwood.compiler.tests.parser.HMMTestPart2b$MultiThreadCPU.Scratch;
...
final class HMMTestPart2b$MultiThreadCPU extends CoreModelMultiThreadCPU<State, Scratch> {
	...
	public HMMTestPart2b$MultiThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
