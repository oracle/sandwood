...
import org.sandwood.compiler.tests.parser.HMMTestPart3$MultiThreadCPU.Scratch;
...
final class HMMTestPart3$MultiThreadCPU extends CoreModelMultiThreadCPU<State, Scratch> {
...
double[][] cv$var28$countGlobal;
	...
	public HMMTestPart3$MultiThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
