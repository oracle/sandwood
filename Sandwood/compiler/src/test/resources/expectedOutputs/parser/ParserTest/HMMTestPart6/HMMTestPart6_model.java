 ...
 */
public final class HMMTestPart6 extends Model<HMMTestPart6.State> {
    ...
    private final ComputedIntegerArrayInternal $st = new ComputedIntegerArrayInternal(this, "st", true, true, false, ProbabilityType.UNSKIPPABLE) {
        ...
        public Immutability isFixed() {
            ...
            boolean fixedFlag$sample78 = state.get$fixedFlag$sample78();
            if(fixedFlag$sample53 && fixedFlag$sample78)
                return Immutability.FIXED;
    ...
    public HMMTestPart6() {
        ...
        HMMTestPart6$SingleThreadCPU core = new HMMTestPart6$SingleThreadCPU(state, ExecutionTarget.singleThread);
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new HMMTestPart6$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new HMMTestPart6$MultiThreadCPU(state, target);
            default:
