...
class Flip1CoinMK9$MultiThreadCPU extends org.sandwood.runtime.internal.model.CoreModelMultiThreadCPU implements Flip1CoinMK9$CoreInterface {
	...
	public Flip1CoinMK9$MultiThreadCPU(ExecutionTarget target) {
		super(target);
	}
