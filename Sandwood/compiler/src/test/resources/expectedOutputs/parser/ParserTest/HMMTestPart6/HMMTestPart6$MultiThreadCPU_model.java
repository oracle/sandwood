...
import org.sandwood.compiler.tests.parser.HMMTestPart6$MultiThreadCPU.Scratch;
...
final class HMMTestPart6$MultiThreadCPU extends CoreModelMultiThreadCPU<State, Scratch> {
	...
	public HMMTestPart6$MultiThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
	...
	private final void drawValueSample78(int i$var66) {
		state.st[(i$var66 - 3)] = DistributionSampling.sampleCategorical(state.RNG$, state.m[((state.states - 1) - state.st[(i$var66 - 4)])], state.states);
	}
					...
					{
						{
							for(int i$var66 = 4; i$var66 < (state.samples + 3); i$var66 += 1) {
								if((var27 == ((state.states - 1) - state.st[(i$var66 - 4)]))) {
									// Processing sample task 78 of consumer random variable null.
									{
										{
											// Flag recording if this sample task of the consuming random variable is constrained.
											boolean cv$sampleConstrained = (state.fixedFlag$sample78 || state.constrainedFlag$sample78[((i$var66 - 4) / 1)]);
											if(cv$sampleConstrained) {
												// Mark that the sample has observed constrained data.
												state.constrainedFlag$sample28[((var27 - 0) / 1)] = true;
												{
					...
					{
						{
							for(int j = 5; j < (state.samples + 5); j += 1) {
								if((var43 == ((state.states - 1) - state.st[(j - 5)]))) {
															...
															{
																{
																	{
																		// Constructing a random variable input for use later.
																		double[] var75 = state.m[((state.states - 1) - traceTempVariable$var73$2_1)];
																		
																		// Record the probability of sample task 78 generating output with current configuration.
																		if(((Math.log(1.0) + ((((((0.0 <= state.st[(i$var66 - 3)]) && (state.st[(i$var66 - 3)] < state.states)) && (0 < state.states)) && (0.0 <= var75[state.st[(i$var66 - 3)]])) && (var75[state.st[(i$var66 - 3)]] <= 1.0))?Math.log(var75[state.st[(i$var66 - 3)]]):Double.NEGATIVE_INFINITY)) < cv$accumulatedConsumerProbabilities))
																			cv$accumulatedConsumerProbabilities = (Math.log((Math.exp(((Math.log(1.0) + ((((((0.0 <= state.st[(i$var66 - 3)]) && (state.st[(i$var66 - 3)] < state.states)) && (0 < state.states)) && (0.0 <= var75[state.st[(i$var66 - 3)]])) && (var75[state.st[(i$var66 - 3)]] <= 1.0))?Math.log(var75[state.st[(i$var66 - 3)]]):Double.NEGATIVE_INFINITY)) - cv$accumulatedConsumerProbabilities)) + 1)) + cv$accumulatedConsumerProbabilities);
																		else {
																			// If the second value is -infinity.
																			if((cv$accumulatedConsumerProbabilities == Double.NEGATIVE_INFINITY))
																				cv$accumulatedConsumerProbabilities = (Math.log(1.0) + ((((((0.0 <= state.st[(i$var66 - 3)]) && (state.st[(i$var66 - 3)] < state.states)) && (0 < state.states)) && (0.0 <= var75[state.st[(i$var66 - 3)]])) && (var75[state.st[(i$var66 - 3)]] <= 1.0))?Math.log(var75[state.st[(i$var66 - 3)]]):Double.NEGATIVE_INFINITY));
																			else
																				cv$accumulatedConsumerProbabilities = (Math.log((Math.exp((cv$accumulatedConsumerProbabilities - (Math.log(1.0) + ((((((0.0 <= state.st[(i$var66 - 3)]) && (state.st[(i$var66 - 3)] < state.states)) && (0 < state.states)) && (0.0 <= var75[state.st[(i$var66 - 3)]])) && (var75[state.st[(i$var66 - 3)]] <= 1.0))?Math.log(var75[state.st[(i$var66 - 3)]]):Double.NEGATIVE_INFINITY)))) + 1)) + (Math.log(1.0) + ((((((0.0 <= state.st[(i$var66 - 3)]) && (state.st[(i$var66 - 3)] < state.states)) && (0 < state.states)) && (0.0 <= var75[state.st[(i$var66 - 3)]])) && (var75[state.st[(i$var66 - 3)]] <= 1.0))?Math.log(var75[state.st[(i$var66 - 3)]]):Double.NEGATIVE_INFINITY)));
																		}
															...
															{
																{
																	{
																		// Constructing a random variable input for use later.
																		double var100 = state.bias[((state.states - 1) - traceTempVariable$var98$5_1)];
																		
																		// Record the probability of sample task 103 generating output with current configuration.
																		if(((Math.log(1.0) + (((0.0 <= var100) && (var100 <= 1.0))?Math.log((state.flips[(j - 5)]?var100:(1.0 - var100))):Double.NEGATIVE_INFINITY)) < cv$accumulatedConsumerProbabilities))
																			cv$accumulatedConsumerProbabilities = (Math.log((Math.exp(((Math.log(1.0) + (((0.0 <= var100) && (var100 <= 1.0))?Math.log((state.flips[(j - 5)]?var100:(1.0 - var100))):Double.NEGATIVE_INFINITY)) - cv$accumulatedConsumerProbabilities)) + 1)) + cv$accumulatedConsumerProbabilities);
																		else {
																			// If the second value is -infinity.
																			if((cv$accumulatedConsumerProbabilities == Double.NEGATIVE_INFINITY))
																				cv$accumulatedConsumerProbabilities = (Math.log(1.0) + (((0.0 <= var100) && (var100 <= 1.0))?Math.log((state.flips[(j - 5)]?var100:(1.0 - var100))):Double.NEGATIVE_INFINITY));
																			else
																				cv$accumulatedConsumerProbabilities = (Math.log((Math.exp((cv$accumulatedConsumerProbabilities - (Math.log(1.0) + (((0.0 <= var100) && (var100 <= 1.0))?Math.log((state.flips[(j - 5)]?var100:(1.0 - var100))):Double.NEGATIVE_INFINITY)))) + 1)) + (Math.log(1.0) + (((0.0 <= var100) && (var100 <= 1.0))?Math.log((state.flips[(j - 5)]?var100:(1.0 - var100))):Double.NEGATIVE_INFINITY)));
																		}
	...
	private final void inferSample78(int i$var66) {
		if(true) {
			state.constrainedFlag$sample78[((i$var66 - 4) / 1)] = false;
			...
			for(int cv$valuePos = 0; cv$valuePos < cv$numStates; cv$valuePos += 1) {
				...
				}
				{
					...
					// Constructing a random variable input for use later.
					double[] var75 = state.m[((state.states - 1) - state.st[(i$var66 - 4)])];
					
					// An accumulator to allow the value for each distribution to be constructed before
					// it is added to the index probabilities.
					double cv$accumulatedProbabilities = (Math.log(1.0) + ((((((0.0 <= cv$currentValue) && (cv$currentValue < state.states)) && (0 < state.states)) && (0.0 <= var75[cv$currentValue])) && (var75[cv$currentValue] <= 1.0))?Math.log(var75[cv$currentValue]):Double.NEGATIVE_INFINITY));
								...
								for(int index$i$2_2 = 4; index$i$2_2 < (state.samples + 3); index$i$2_2 += 1) {
									if(((i$var66 - 3) == (index$i$2_2 - 4))) {
										// Processing sample task 78 of consumer random variable null.
										{
											{
												// Flag recording if this sample task of the consuming random variable is constrained.
												boolean cv$sampleConstrained = (state.fixedFlag$sample78 || state.constrainedFlag$sample78[((index$i$2_2 - 4) / 1)]);
												if(cv$sampleConstrained) {
													// Mark that the sample has observed constrained data.
													state.constrainedFlag$sample78[((i$var66 - 4) / 1)] = true;
															...
															{
																{
																	{
																		// Constructing a random variable input for use later.
																		double[] sc$var75$1 = state.m[((state.states - 1) - traceTempVariable$var73$2_1)];
																		
																		// Record the probability of sample task 78 generating output with current configuration.
																		if(((Math.log(1.0) + ((((((0.0 <= state.st[(index$i$2_2 - 3)]) && (state.st[(index$i$2_2 - 3)] < state.states)) && (0 < state.states)) && (0.0 <= sc$var75$1[state.st[(index$i$2_2 - 3)]])) && (sc$var75$1[state.st[(index$i$2_2 - 3)]] <= 1.0))?Math.log(sc$var75$1[state.st[(index$i$2_2 - 3)]]):Double.NEGATIVE_INFINITY)) < cv$accumulatedConsumerProbabilities))
																			cv$accumulatedConsumerProbabilities = (Math.log((Math.exp(((Math.log(1.0) + ((((((0.0 <= state.st[(index$i$2_2 - 3)]) && (state.st[(index$i$2_2 - 3)] < state.states)) && (0 < state.states)) && (0.0 <= sc$var75$1[state.st[(index$i$2_2 - 3)]])) && (sc$var75$1[state.st[(index$i$2_2 - 3)]] <= 1.0))?Math.log(sc$var75$1[state.st[(index$i$2_2 - 3)]]):Double.NEGATIVE_INFINITY)) - cv$accumulatedConsumerProbabilities)) + 1)) + cv$accumulatedConsumerProbabilities);
																		else {
																			// If the second value is -infinity.
																			if((cv$accumulatedConsumerProbabilities == Double.NEGATIVE_INFINITY))
																				cv$accumulatedConsumerProbabilities = (Math.log(1.0) + ((((((0.0 <= state.st[(index$i$2_2 - 3)]) && (state.st[(index$i$2_2 - 3)] < state.states)) && (0 < state.states)) && (0.0 <= sc$var75$1[state.st[(index$i$2_2 - 3)]])) && (sc$var75$1[state.st[(index$i$2_2 - 3)]] <= 1.0))?Math.log(sc$var75$1[state.st[(index$i$2_2 - 3)]]):Double.NEGATIVE_INFINITY));
																			else
			...
			if(state.constrainedFlag$sample78[((i$var66 - 4) / 1)]) {
				// The sum of all the probabilities in log space
				double cv$logSum = 0.0;
				...
				// Write out the value of the sample to a temporary variable prior to updating the
				// intermediate variables.
				int var77 = DistributionSampling.sampleCategorical(state.RNG$, cv$stateProbabilityLocal, cv$numStates);
				
				// Guards to ensure that st is only updated when there is a valid path.
				{
					{
						{
							state.st[(i$var66 - 3)] = var77;
						}
					}
				}
			}
	...
	private final void logProbabilityValue$sample103() {
		...
		if(!state.fixedProbFlag$sample103) {
			...
			for(int j = 5; j < (state.samples + 5); j += 1) {
				...
				{
					{
						...
						{
							{
								double var100 = state.bias[((state.states - 1) - state.st[(j - 5)])];
								
								// Store the value of the function call, so the function call is only made once.
								double cv$weightedProbability = (Math.log(1.0) + (((0.0 <= var100) && (var100 <= 1.0))?Math.log((cv$sampleValue?var100:(1.0 - var100))):Double.NEGATIVE_INFINITY));
				...
				state.logProbability$sample103[((j - 5) / 1)] = cv$sampleProbability;
			}
			...
			for(int j = 5; j < (state.samples + 5); j += 1) {
				...
				double cv$sampleValue = state.logProbability$sample103[((j - 5) / 1)];
	...
	private final void logProbabilityValue$sample78() {
		...
		if(!state.fixedProbFlag$sample78) {
			...
			for(int i$var66 = 4; i$var66 < (state.samples + 3); i$var66 += 1) {
						...
						{
							{
								...
								// Store the value of the function call, so the function call is only made once.
								double cv$weightedProbability = (Math.log(1.0) + ((((((0.0 <= cv$sampleValue) && (cv$sampleValue < state.states)) && (0 < state.states)) && (0.0 <= var75[cv$sampleValue])) && (var75[cv$sampleValue] <= 1.0))?Math.log(var75[cv$sampleValue]):Double.NEGATIVE_INFINITY));
				...
				// Store the sample task probability
				state.logProbability$sample78[((i$var66 - 4) / 1)] = cv$sampleProbability;
			}
			...
			for(int i$var66 = 4; i$var66 < (state.samples + 3); i$var66 += 1) {
				double cv$rvAccumulator = 0.0;
				double cv$sampleValue = state.logProbability$sample78[((i$var66 - 4) / 1)];
				cv$rvAccumulator = (cv$rvAccumulator + cv$sampleValue);
		...
		parallelFor(state.RNG$, 5, (state.samples + 5), 1,
			(int forStart$j, int forEnd$j, int threadID$j, org.sandwood.random.internal.Rng RNG$1) -> { 
					...
					for(int j = forStart$j; j < forEnd$j; j += 1)
						state.flips[(j - 5)] = DistributionSampling.sampleBernoulli(RNG$1, state.bias[((state.states - 1) - state.st[(j - 5)])]);
			}
		);
	}
	...
	private final void initializeLogProbabilityFields() {
		...
		if(!state.fixedProbFlag$sample78) {
			for(int i$var66 = 4; i$var66 < (state.samples + 3); i$var66 += 1)
				state.logProbability$sample78[((i$var66 - 4) / 1)] = Double.NaN;
		}
		state.logProbability$flips = 0.0;
		if(!state.fixedProbFlag$sample103) {
			for(int j = 5; j < (state.samples + 5); j += 1)
				state.logProbability$sample103[((j - 5) / 1)] = Double.NaN;
		}
	}
