...
class HMMTestPart6$MultiThreadCPU extends org.sandwood.runtime.internal.model.CoreModelMultiThreadCPU implements HMMTestPart6$CoreInterface {
	...
	private final void logProbabilityValue$sample103() {
		...
		if(!fixedProbFlag$sample103) {
			...
			fixedProbFlag$sample103 = (((fixedFlag$sample103 && fixedFlag$sample45) && fixedFlag$sample53) && fixedFlag$sample78);
		}
		// Using cached values.
		else {
		...
		for(int cv$valuePos = 0; cv$valuePos < cv$numNumStates; cv$valuePos += 1) {
			...
			st[0] = cv$currentValue;
			{
											...
											{
												{
													...
													{
														// Constructing a random variable input for use later.
														double[] var75 = m[((states - 1) - traceTempVariable$var73$1_1)];
				...
				// Processing random variable 101.
				{
					...
					{
						int traceTempVariable$var98$4_1 = cv$currentValue;
						for(int j = 5; j < (samples + 5); j += 1) {
							if((0 == (j - 5))) {
								// Processing sample task 103 of consumer random variable null.
								{
											...
											{
												{
													...
													{
														// Constructing a random variable input for use later.
														double var100 = bias[((states - 1) - traceTempVariable$var98$4_1)];
											...
											{
												{
													...
													// Record the probability of sample task 78 generating output with current configuration.
													if(((Math.log(1.0) + (((0.0 <= st[(index$i$1_2 - 3)]) && (st[(index$i$1_2 - 3)] < cv$temp$3$$var388))?Math.log(cv$temp$2$var75[st[(index$i$1_2 - 3)]]):Double.NEGATIVE_INFINITY)) < cv$accumulatedConsumerProbabilities))
														cv$accumulatedConsumerProbabilities = (Math.log((Math.exp(((Math.log(1.0) + (((0.0 <= st[(index$i$1_2 - 3)]) && (st[(index$i$1_2 - 3)] < cv$temp$3$$var388))?Math.log(cv$temp$2$var75[st[(index$i$1_2 - 3)]]):Double.NEGATIVE_INFINITY)) - cv$accumulatedConsumerProbabilities)) + 1)) + cv$accumulatedConsumerProbabilities);
													else {
														// If the second value is -infinity.
														if((cv$accumulatedConsumerProbabilities == Double.NEGATIVE_INFINITY))
															cv$accumulatedConsumerProbabilities = (Math.log(1.0) + (((0.0 <= st[(index$i$1_2 - 3)]) && (st[(index$i$1_2 - 3)] < cv$temp$3$$var388))?Math.log(cv$temp$2$var75[st[(index$i$1_2 - 3)]]):Double.NEGATIVE_INFINITY));
														else
															cv$accumulatedConsumerProbabilities = (Math.log((Math.exp((cv$accumulatedConsumerProbabilities - (Math.log(1.0) + (((0.0 <= st[(index$i$1_2 - 3)]) && (st[(index$i$1_2 - 3)] < cv$temp$3$$var388))?Math.log(cv$temp$2$var75[st[(index$i$1_2 - 3)]]):Double.NEGATIVE_INFINITY)))) + 1)) + (Math.log(1.0) + (((0.0 <= st[(index$i$1_2 - 3)]) && (st[(index$i$1_2 - 3)] < cv$temp$3$$var388))?Math.log(cv$temp$2$var75[st[(index$i$1_2 - 3)]]):Double.NEGATIVE_INFINITY)));
													}
