...
public class Flip2CoinsMK15Fail extends GeneratedAPIBuilder {
    @Override
    public CompilationDesc buildClass(CompilationOptions opts) {
        ...
        parFor(intVariable(0, location(17, 16, 17, 16)), coins, intVariable(1, location(17, 15, 17, 18)), true, location(17, 5, 17, 25), (j) -> { 
            ...
            ArrayVariable<BooleanVariable> f = bernoulli.sample(samples, location(20, 40, 20, 54));
            f.setAlias("f");
            f.setLocation(location(20, 26, 20, 26));
            f.setPublic();

            flips.put(j, f, location(21, 14, 21, 20));
        ...
        return compileAPI(opts, $variableNames, "Flip2CoinsMK15Fail", $helperClasses, "org.sandwood.compiler.tests.parser", $constructorArgs, getOriginalModel(), null);
    }
