...
import org.sandwood.compiler.tests.parser.Conditional2d$MultiThreadCPU.Scratch;
...
final class Conditional2d$MultiThreadCPU extends CoreModelMultiThreadCPU<State, Scratch> {
...
double[] cv$var4$stateProbabilityGlobal;
	...
	public Conditional2d$MultiThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
