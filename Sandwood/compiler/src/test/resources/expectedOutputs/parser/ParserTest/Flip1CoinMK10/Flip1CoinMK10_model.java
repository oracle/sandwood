...
/**
  * Class representing the Sandwood model Flip1CoinMK10 This is the class that
  * all user interactions with the model should occur through.
  */
public class Flip1CoinMK10 extends Model {

    private Flip1CoinMK10$CoreInterface system$c = new Flip1CoinMK10$SingleThreadCPU(ExecutionTarget.singleThread);
    ...
    public Flip1CoinMK10(int flipsMeasuredShape) {
        this();
    ...
    public Flip1CoinMK10(boolean[] flipsMeasured) {
        this();
        this.flipsMeasured.setValue(flipsMeasured);
    }
    
    @Override
    protected Flip1CoinMK10$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        Flip1CoinMK10$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new Flip1CoinMK10$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new Flip1CoinMK10$MultiThreadCPU(target);
                break;
            default:
    ...
    private void transferData(Flip1CoinMK10$CoreInterface oldCore, Flip1CoinMK10$CoreInterface newCore) {
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(Flip1CoinMK10 system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(Flip1CoinMK10 system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(Flip1CoinMK10 system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(Flip1CoinMK10 system$model) {
