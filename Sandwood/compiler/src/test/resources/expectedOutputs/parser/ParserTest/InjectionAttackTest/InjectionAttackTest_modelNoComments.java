...
public final class InjectionAttackTest extends Model<InjectionAttackTest.State> {
...
double bias;
    ...
    public InjectionAttackTest() {
        ...
        InjectionAttackTest$SingleThreadCPU core = new InjectionAttackTest$SingleThreadCPU(state, ExecutionTarget.singleThread);
	 ...
	 */
    public InjectionAttackTest(int observedSampleCount) {
        this();
	 ...
	 */
    public InjectionAttackTest(int observedSampleCount, int observedPositiveCount) {
        this();
        this.observedSampleCount.setValue(observedSampleCount);
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new InjectionAttackTest$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new InjectionAttackTest$MultiThreadCPU(state, target);
            default:
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(InjectionAttackTest system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(InjectionAttackTest system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(InjectionAttackTest system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(InjectionAttackTest system$model) {
