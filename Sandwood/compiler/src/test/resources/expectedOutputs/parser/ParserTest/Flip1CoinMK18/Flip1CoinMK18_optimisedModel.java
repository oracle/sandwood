...
public class Flip1CoinMK18 extends Model {
    ...
    private final ComputedObjectArrayInternal<double[][]> $bias = new ComputedObjectArrayInternal<double[][]>(this, "bias", false, false, false, org.sandwood.runtime.internal.model.util.BaseType.DOUBLE, 3) {
        @Override
