...
/**
  * Class representing the Sandwood model Conditional2d This is the class that
  * all user interactions with the model should occur through.
  */
public class Conditional2d extends Model {

    private Conditional2d$CoreInterface system$c = new Conditional2d$SingleThreadCPU(ExecutionTarget.singleThread);
    ...
    @Override
    protected Conditional2d$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        Conditional2d$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new Conditional2d$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new Conditional2d$MultiThreadCPU(target);
                break;
            default:
    ...
    private void transferData(Conditional2d$CoreInterface oldCore, Conditional2d$CoreInterface newCore) {
        //Observed scalars
