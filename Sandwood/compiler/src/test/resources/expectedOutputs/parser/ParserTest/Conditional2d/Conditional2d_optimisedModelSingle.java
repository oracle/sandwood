...
/**
 * Class representing the Sandwood model Conditional2d This is the class that all
 * user interactions with the model should occur through.
 */
public final class Conditional2d extends Model<Conditional2d.State> {
    ...
    public Conditional2d() {
        ...
        Conditional2d$SingleThreadCPU core = new Conditional2d$SingleThreadCPU(state, ExecutionTarget.singleThread);
	 ...
	 */
    public Conditional2d(double[] observedValue) {
        this();
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new Conditional2d$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new Conditional2d$MultiThreadCPU(state, target);
            default:
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(Conditional2d system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(Conditional2d system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(Conditional2d system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(Conditional2d system$model) {
