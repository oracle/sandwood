...
import org.sandwood.compiler.tests.parser.NullModelMK2$MultiThreadCPU.Scratch;
...
final class NullModelMK2$MultiThreadCPU extends CoreModelMultiThreadCPU<State, Scratch> {
	...
	public NullModelMK2$MultiThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
