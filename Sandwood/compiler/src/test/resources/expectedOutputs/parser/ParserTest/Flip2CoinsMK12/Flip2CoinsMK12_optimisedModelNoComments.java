...
/**
  * Class representing the Sandwood model Flip2CoinsMK12 This is the class that
  * all user interactions with the model should occur through.
  */
public class Flip2CoinsMK12 extends Model {
    ...
    private final ComputedDoubleArrayInternal $bias = new ComputedDoubleArrayInternal(this, "bias", true) {
        ...
        public Immutability isFixed() {
            ...
            if(fixedFlag$sample16 && fixedFlag$sample21)
                return Immutability.FIXED;
            else if(fixedFlag$sample16 || fixedFlag$sample21)
    ...
    private final ComputedObjectArrayInternal<boolean[]> $flips = new ComputedObjectArrayInternal<boolean[]>(this, "flips", true, org.sandwood.runtime.internal.model.util.BaseType.BOOLEAN, 2) {
        ...
        public Immutability isFixed() {
            ...
            if(fixedFlag$sample37 && fixedFlag$sample54)
                return Immutability.FIXED;
            else if(fixedFlag$sample37 || fixedFlag$sample54)
                return Immutability.PARTIALLY_FIXED;
            else
                return Immutability.FREE;
        }
    ...
    public Flip2CoinsMK12(int[] flipsMeasuredShape) {
        this();
    ...
    public Flip2CoinsMK12(boolean[][] flipsMeasured) {
        this();
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(Flip2CoinsMK12 system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(Flip2CoinsMK12 system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(Flip2CoinsMK12 system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(Flip2CoinsMK12 system$model) {
