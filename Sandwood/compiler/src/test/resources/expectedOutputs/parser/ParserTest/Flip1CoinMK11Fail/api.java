...
public class Flip1CoinMK11Fail extends GeneratedAPIBuilder {
    @Override
    public CompilationDesc buildClass(CompilationOptions opts) {
        //Allocating initial observed parameters
        ArrayVariable<BooleanVariable> flipsMeasured = observeArray("flipsMeasured", VariableType.arrayType(VariableType.BooleanVariable), location(11, 32, 11, 54));
        ...
        parFor(intVariable(0, location(19, 16, 19, 16)), samples, intVariable(1, location(19, 15, 19, 18)), true, location(19, 5, 19, 27), (i) -> { 
            ...
            (booleanVariable(false, location(20, 10, 20, 14)).or(flips.get(i, location(20, 24, 20, 26)), location(20, 16, 20, 17))).observe(flipsMeasured.get(i, location(20, 50, 20, 52)), location(20, 29, 20, 53));
        });
        ...
        return compileAPI(opts, $variableNames, "Flip1CoinMK11Fail", $helperClasses, "org.sandwood.compiler.tests.parser", $constructorArgs, getOriginalModel(), null);
    }

    private static String getOriginalModel() { 
        return "/*\n * Sandwood\n *\n * Copyright (c) 2019-2023, Oracle and/or its affiliates\n * \n * Licensed under the Universal Permissive License v 1.0 as shown at https://oss.oracle.com/licenses/upl/\n */\n\npackage org.sandwood.compiler.tests.parser;\n\npublic model Flip1CoinMK11Fail(boolean[] flipsMeasured) {\n    int samples = flipsMeasured.length;\n        \n    double bias = beta(1.0, 1).sample();\n        \n    Bernoulli bernoulli = bernoulli(bias);\n    boolean[] flips = bernoulli.sample(samples);\n\n    for(int i:[0..samples))\n        (false || flips[i]).observe(flipsMeasured[i]);\n}\n";
    }
}