...
class Dice3$SingleThreadCPU extends org.sandwood.runtime.internal.model.CoreModelSingleThreadCPU implements Dice3$CoreInterface {
	...
	public Dice3$SingleThreadCPU(ExecutionTarget target) {
		super(target);
	}
	...
	private final void logProbabilityValue$sample11() {
		...
		if(!fixedProbFlag$sample11) {
			...
			// Guard to ensure that even is only updated once for this probability.
	...
	private final void logProbabilityValue$sample15() {
		...
		if(!fixedProbFlag$sample15) {
			...
			// Guard to ensure that odd is only updated once for this probability.
