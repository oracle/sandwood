											...
											if(((0 <= j$var38) && (j$var38 < noProducts))) {
												if((0 < noProducts)) {
													...
													for(int cv$reduction2499Index = 0; cv$reduction2499Index < j$var38; cv$reduction2499Index += 1) {
														...
														// Set the right hand term to a value from the array exped
														double l$var50 = exped[cv$reduction2499Index];
													...
													for(int cv$reduction2499Index = (j$var38 + 1); cv$reduction2499Index < noProducts; cv$reduction2499Index += 1) {
														// Set the left hand term of the reduction function to the return variable value.
														double k$var49 = reduceVar$sum$12;
																	...
																	if(((0 <= j$var123) && (j$var123 < noProducts))) {
																		if((0 < noProducts)) {
																			...
																			for(int cv$reduction2533Index = 0; cv$reduction2533Index < j$var123; cv$reduction2533Index += 1) {
																				...
																				// Set the right hand term to a value from the array weekly_ut
																				double l$var136 = weekly_ut[((t$var112 - 0) / 1)][cv$reduction2533Index];
																			...
																			for(int cv$reduction2533Index = (j$var123 + 1); cv$reduction2533Index < noProducts; cv$reduction2533Index += 1) {
																				// Set the left hand term of the reduction function to the return variable value.
																				double k$var135 = reduceVar$denom$24;
											...
											if(((0 <= j$var38) && (j$var38 < noProducts))) {
												if((0 < noProducts)) {
													...
													for(int cv$reduction2561Index = 0; cv$reduction2561Index < j$var38; cv$reduction2561Index += 1) {
														...
														// Set the right hand term to a value from the array exped
														double l$var50 = exped[cv$reduction2561Index];
													...
													for(int cv$reduction2561Index = (j$var38 + 1); cv$reduction2561Index < noProducts; cv$reduction2561Index += 1) {
														// Set the left hand term of the reduction function to the return variable value.
														double k$var49 = reduceVar$sum$13;
																...
																if(((0 <= j$var123) && (j$var123 < noProducts))) {
																	if((0 < noProducts)) {
																		...
																		for(int cv$reduction2617Index = 0; cv$reduction2617Index < j$var123; cv$reduction2617Index += 1) {
																			...
																			// Set the right hand term to a value from the array weekly_ut
																			double l$var136 = weekly_ut[((t$var112 - 0) / 1)][cv$reduction2617Index];
																		...
																		for(int cv$reduction2617Index = (j$var123 + 1); cv$reduction2617Index < noProducts; cv$reduction2617Index += 1) {
																			// Set the left hand term of the reduction function to the return variable value.
																			double k$var135 = reduceVar$denom$25;
