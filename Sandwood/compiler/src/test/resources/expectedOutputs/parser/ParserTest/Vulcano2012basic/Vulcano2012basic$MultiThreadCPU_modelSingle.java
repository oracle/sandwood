									...
									{
										{
											...
											for(int cv$reduction425Index = 0; cv$reduction425Index < noProducts; cv$reduction425Index += 1) {
												...
												double l = exped[cv$reduction425Index];
								...
								if(((0 <= j$var28) && (j$var28 < noProducts))) {
									{
										if((0 < noProducts)) {
											...
											for(int cv$reduction482Index = 0; cv$reduction482Index < j$var28; cv$reduction482Index += 1) {
												// Set the left hand term of the reduction function to the return variable value.
												double k = reduceVar$sum$9;
												
												// Set the right hand term to a value from the array exped
												double l = exped[cv$reduction482Index];
											...
											for(int cv$reduction482Index = (j$var28 + 1); cv$reduction482Index < noProducts; cv$reduction482Index += 1) {
												// Set the left hand term of the reduction function to the return variable value.
												double k = reduceVar$sum$9;
							...
							{
								{
									...
									for(int cv$reduction535Index = 0; cv$reduction535Index < noProducts; cv$reduction535Index += 1) {
										...
										// Set the right hand term to a value from the array exped
										double l = exped[cv$reduction535Index];
