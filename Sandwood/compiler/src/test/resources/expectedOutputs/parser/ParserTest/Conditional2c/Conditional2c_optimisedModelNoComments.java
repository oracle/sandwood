...
/**
 * Class representing the Sandwood model Conditional2c This is the class that all
 * user interactions with the model should occur through.
 */
public final class Conditional2c extends Model<Conditional2c.State> {
...
boolean constrainedFlag$sample4 = true;
		...
		final double get$logProbability$value2() {
    ...
    private final ComputedDoubleInternal $v = new ComputedDoubleInternal(this, "v", false, false, false, ProbabilityType.UNSKIPPABLE) {
        @Override
        public double getValue() { return state.get$v(); }
        ...
        protected void testSettable() {
            throw new SandwoodException("Set is not available for variable v because its value depends on variable \"u\".");
        }
	...
	/** Computed variable representing v of type double from the Sandwood model. */
    public final ComputedDouble v = $v;

    private final ComputedDoubleArrayInternal $value = new ComputedDoubleArrayInternal(this, "value", false, false, false, ProbabilityType.UNSKIPPABLE) {
        @Override
    ...
    private final ComputedDoubleArrayInternal $value2 = new ComputedDoubleArrayInternal(this, "value2", false, false, false, ProbabilityType.UNSKIPPABLE) {
        @Override
        public double[] getValue() { return state.get$value2(); }
        ...
        @Override
        public double getCurrentLogProbability() { return state.get$logProbability$value2(); }
	...
	/**
	 * Observed variable representing observedValue of type double[] from the Sandwood
	 * model.
	 */
    ...
    private HasProbabilityInternal[] $probabilityVariables = {$guard, $u, $v, $value, $value2, $bernoulli};

    // Constructors
	/** A constructor for a model where no variable values are set. */
    public Conditional2c() {
        super();
        state = new State();
        //ComputedVariable
        ...
        Conditional2c$SingleThreadCPU core = new Conditional2c$SingleThreadCPU(state, ExecutionTarget.singleThread);
	 ...
	 */
    public Conditional2c(double[] observedValue) {
        this();
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new Conditional2c$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new Conditional2c$MultiThreadCPU(state, target);
            default:
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(Conditional2c system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(Conditional2c system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(Conditional2c system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        public final double[] u;
		/** Field holding the MAP or Sample value of v after an infer model call. */
        public final double[] v;

        InferredModelOutputs(Conditional2c system$model) {
            this.guard = system$model.getInferredValue(system$model.$guard);
            this.u = system$model.getInferredValue(system$model.$u);
            this.v = system$model.getInferredValue(system$model.$v);
        }
    }
