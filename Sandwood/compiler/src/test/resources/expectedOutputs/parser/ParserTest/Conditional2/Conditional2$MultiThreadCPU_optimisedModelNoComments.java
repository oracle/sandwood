...
import org.sandwood.compiler.tests.parser.Conditional2$MultiThreadCPU.Scratch;
...
final class Conditional2$MultiThreadCPU extends CoreModelMultiThreadCPU<State, Scratch> {
...
double[] cv$var4$stateProbabilityGlobal;
	...
	public Conditional2$MultiThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
