 ...
 */
public final class Flip1CoinMK3 extends Model<Flip1CoinMK3.State> {
    ...
    public Flip1CoinMK3() {
        ...
        Flip1CoinMK3$SingleThreadCPU core = new Flip1CoinMK3$SingleThreadCPU(state, ExecutionTarget.singleThread);
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new Flip1CoinMK3$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new Flip1CoinMK3$MultiThreadCPU(state, target);
            default:
