...
/**
 * Class representing the Sandwood model Conditional2e This is the class that all
 * user interactions with the model should occur through.
 */
public final class Conditional2e extends Model<Conditional2e.State> {
    ...
    public Conditional2e() {
        ...
        Conditional2e$SingleThreadCPU core = new Conditional2e$SingleThreadCPU(state, ExecutionTarget.singleThread);
	 ...
	 */
    public Conditional2e(double[] observedValue) {
        this();
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new Conditional2e$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new Conditional2e$MultiThreadCPU(state, target);
            default:
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(Conditional2e system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(Conditional2e system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(Conditional2e system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(Conditional2e system$model) {
