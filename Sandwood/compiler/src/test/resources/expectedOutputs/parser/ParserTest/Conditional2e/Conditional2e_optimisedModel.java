...
/**
  * Class representing the Sandwood model Conditional2e This is the class that
  * all user interactions with the model should occur through.
  */
public final class Conditional2e extends Model {
    ...
    @Override
    protected Conditional2e$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        Conditional2e$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new Conditional2e$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new Conditional2e$MultiThreadCPU(target);
                break;
            default:
    ...
    private void transferData(Conditional2e$CoreInterface oldCore, Conditional2e$CoreInterface newCore) {
        //Observed scalars
