...
public class Flip2CoinsMK7 extends GeneratedAPIBuilder {
    @Override
    public CompilationDesc buildClass(CompilationOptions opts) {
        ...
        parFor(intVariable(0, location(15, 16, 15, 16)), coins, intVariable(1, location(15, 15, 15, 18)), true, location(15, 5, 15, 25), (i) -> { 
            ...
            bias.put(i, intVariable(1, location(16, 19, 16, 19)).subtract(beta(a, b, location(16, 23, 16, 32)).sample(location(16, 34, 16, 41)), location(16, 21, 16, 21)), location(16, 13, 16, 21));
        });
        ...
        parFor(intVariable(0, location(20, 16, 20, 16)), coins, intVariable(1, location(20, 15, 20, 18)), true, location(20, 5, 20, 25), (j) -> { 
            ...
            Bernoulli bernoulli = bernoulli(bias.get(j, location(22, 45, 22, 47)), location(22, 31, 22, 48));
        ...
        return compileAPI(opts, $variableNames, "Flip2CoinsMK7", $helperClasses, "org.sandwood.compiler.tests.parser", $constructorArgs, getOriginalModel(), null);
    }
