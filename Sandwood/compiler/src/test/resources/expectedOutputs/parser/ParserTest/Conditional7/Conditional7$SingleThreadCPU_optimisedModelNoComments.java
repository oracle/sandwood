...
class Conditional7$SingleThreadCPU extends org.sandwood.runtime.internal.model.CoreModelSingleThreadCPU implements Conditional7$CoreInterface {
	...
	public Conditional7$SingleThreadCPU(ExecutionTarget target) {
		super(target);
	}
