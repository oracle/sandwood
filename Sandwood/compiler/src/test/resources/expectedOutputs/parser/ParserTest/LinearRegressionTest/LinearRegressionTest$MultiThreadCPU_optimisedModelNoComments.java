...
class LinearRegressionTest$MultiThreadCPU extends org.sandwood.runtime.internal.model.CoreModelMultiThreadCPU implements LinearRegressionTest$CoreInterface {
	...
	private final void logProbabilityValue$sample63() {
		if(!fixedProbFlag$sample63) {
			...
			for(int i$var38 = 0; i$var38 < n; i$var38 += 1) {
				...
				double cv$distributionAccumulator = DistributionSampling.logProbabilityGaussian(y[i$var38], (reduceVar$var55$8 + bias), tau);
	...
	private final void sample28(int var23) {
		...
		for(int i$var38 = 0; i$var38 < n; i$var38 += 1) {
			...
			for(int cv$reduction259Index = 0; cv$reduction259Index < var23; cv$reduction259Index += 1)
				reduceVar$var55$5 = (reduceVar$var55$5 + phi[i$var38][cv$reduction259Index]);
			for(int cv$reduction259Index = (var23 + 1); cv$reduction259Index < k; cv$reduction259Index += 1)
				reduceVar$var55$5 = (reduceVar$var55$5 + phi[i$var38][cv$reduction259Index]);
