...
/**
  * Class representing the Sandwood model HMMTestFromStan This is the class that
  * all user interactions with the model should occur through.
  */
public class HMMTestFromStan extends Model {

    private HMMTestFromStan$CoreInterface system$c = new HMMTestFromStan$SingleThreadCPU(ExecutionTarget.singleThread);
    ...
    private final ComputedIntegerArrayInternal $st = new ComputedIntegerArrayInternal(this, "st", true) {
        ...
        public Immutability isFixed() {
            ...
            if(fixedFlag$sample35 && fixedFlag$sample46)
                return Immutability.FIXED;
            else if(fixedFlag$sample35 || fixedFlag$sample46)
    ...
    public HMMTestFromStan(int flipsMeasuredShape) {
        this();
    ...
    public HMMTestFromStan(boolean[] flipsMeasured) {
        this();
        this.flipsMeasured.set(flipsMeasured);
    }
    
    @Override
    protected HMMTestFromStan$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        HMMTestFromStan$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new HMMTestFromStan$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new HMMTestFromStan$MultiThreadCPU(target);
                break;
            default:
    ...
    private void transferData(HMMTestFromStan$CoreInterface oldCore, HMMTestFromStan$CoreInterface newCore) {
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(HMMTestFromStan system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(HMMTestFromStan system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(HMMTestFromStan system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(HMMTestFromStan system$model) {
