...
public class RaggedArray2 extends GeneratedAPIBuilder {
    ...
    public CompilationDesc buildClass(CompilationOptions opts) {
        ...
        ArrayVariable<DoubleVariable> c = ArrayVariable.getArrayVariable(() -> {
                ArrayVariable<DoubleVariable> c$ = Variable.arrayVariable(location(14, 18, 14, 31), VariableType.DoubleVariable, 2);
                c$.put(intVariable(0, location(14, 18, 14, 18)), doubleVariable(0.35, location(14, 20, 14, 23)), location(14, 18, 14, 23));
        ...
        IntVariable y = categorical(c, location(15, 13, 15, 26)).sample(location(15, 28, 15, 35));
        y.setAlias("y");
