...
public class HMMMetrics3Fail extends GeneratedAPIBuilder {
    @Override
    public CompilationDesc buildClass(CompilationOptions opts) {
        //Allocating initial observed parameters
        ArrayVariable<ArrayVariable<IntVariable>> metric = observeArray("metric", VariableType.arrayType(VariableType.arrayType(VariableType.IntVariable)), location(12, 16, 12, 29));
        ...
        ArrayVariable<ArrayVariable<IntVariable>> metric_g = Variable.arrayVariable(location(27, 31, 27, 43), VariableType.arrayType(VariableType.IntVariable), noSamples);
        metric_g.setAlias("metric_g");
        metric_g.setLocation(location(27, 13, 27, 20));
        ...
        parFor(intVariable(0, location(36, 22, 36, 22)), noSamples, intVariable(1, location(36, 45, 36, 52)), true, location(36, 5, 36, 53), (sample) -> { 
            ...
            parFor(intVariable(0, location(58, 28, 58, 28)), streamLength, intVariable(1, location(58, 56, 58, 65)), true, location(58, 9, 58, 66), (timeStep) -> { 
                ...
                metric_1d.get(timeStep, location(65, 22, 65, 31)).observe(metric.get(sample, location(65, 55, 65, 62)).get(timeStep, location(65, 63, 65, 72)).castToDouble(location(65, 41, 65, 48)), location(65, 33, 65, 73));
        ...
        return compileAPI(opts, $variableNames, "HMMMetrics3Fail", $helperClasses, "org.sandwood.compiler.tests.parser", $constructorArgs, getOriginalModel(), null);
    }
