...
/**
 * Class representing the Sandwood model Conditional2 This is the class that all user
 * interactions with the model should occur through.
 */
public final class Conditional2 extends Model<Conditional2.State> {
...
boolean constrainedFlag$sample4 = true;
    ...
    public Conditional2() {
        ...
        Conditional2$SingleThreadCPU core = new Conditional2$SingleThreadCPU(state, ExecutionTarget.singleThread);
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new Conditional2$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new Conditional2$MultiThreadCPU(state, target);
            default:
