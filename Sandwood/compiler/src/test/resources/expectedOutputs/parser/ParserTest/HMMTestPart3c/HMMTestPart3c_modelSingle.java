...
/**
 * Class representing the Sandwood model HMMTestPart3c This is the class that all
 * user interactions with the model should occur through.
 */
public final class HMMTestPart3c extends Model<HMMTestPart3c.State> {
	final class State extends CoreModelState {
		...
		final boolean get$fixedFlag$sample74() {
			return fixedFlag$sample74;
		}

		// Setter for fixedFlag$sample74.
		final void set$fixedFlag$sample74(boolean cv$value, boolean allocated$) {
    ...
    private final ComputedIntegerArrayInternal $st = new ComputedIntegerArrayInternal(this, "st", true, true, false, ProbabilityType.UNSKIPPABLE) {
        ...
        public void setFixed(boolean fixed) {
            synchronized(model) {
                ...
                state.set$fixedFlag$sample74(fixed, allocated);
            }
        }
        ...
        public Immutability isFixed() {
            ...
            boolean fixedFlag$sample74 = state.get$fixedFlag$sample74();
            if(fixedFlag$sample53 && fixedFlag$sample74)
                return Immutability.FIXED;
            else if(fixedFlag$sample53 || fixedFlag$sample74)
    ...
    public HMMTestPart3c() {
        ...
        HMMTestPart3c$SingleThreadCPU core = new HMMTestPart3c$SingleThreadCPU(state, ExecutionTarget.singleThread);
	 ...
	 */
    public HMMTestPart3c(int flipsMeasuredShape) {
        this();
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new HMMTestPart3c$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new HMMTestPart3c$MultiThreadCPU(state, target);
            default:
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(HMMTestPart3c system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(HMMTestPart3c system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(HMMTestPart3c system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(HMMTestPart3c system$model) {
