...
/**
  * Class representing the Sandwood model HMMTestPart3c This is the class that
  * all user interactions with the model should occur through.
  */
public class HMMTestPart3c extends Model {

    private HMMTestPart3c$CoreInterface system$c = new HMMTestPart3c$SingleThreadCPU(ExecutionTarget.singleThread);
    ...
    private final ComputedIntegerArrayInternal $st = new ComputedIntegerArrayInternal(this, "st", true) {
        ...
        public Immutability isFixed() {
            ...
            if(fixedFlag$sample36 && fixedFlag$sample49)
                return Immutability.FIXED;
            else if(fixedFlag$sample36 || fixedFlag$sample49)
    ...
    @Override
    protected HMMTestPart3c$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        HMMTestPart3c$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new HMMTestPart3c$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new HMMTestPart3c$MultiThreadCPU(target);
                break;
            default:
    ...
    private void transferData(HMMTestPart3c$CoreInterface oldCore, HMMTestPart3c$CoreInterface newCore) {
