...
import org.sandwood.compiler.tests.parser.LinearRegressionWrongNameFail$SingleThreadCPU.Scratch;
import org.sandwood.compiler.tests.parser.LinearRegressionWrongNameFail.State;
...
final class LinearRegressionWrongNameFail$SingleThreadCPU extends CoreModelSingleThreadCPU<State, Scratch> {
	...
	public LinearRegressionWrongNameFail$SingleThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
