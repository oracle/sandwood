...
import org.sandwood.compiler.tests.parser.AlternativeModelMK3$MultiThreadCPU.Scratch;
...
final class AlternativeModelMK3$MultiThreadCPU extends CoreModelMultiThreadCPU<State, Scratch> {
	...
	public AlternativeModelMK3$MultiThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
