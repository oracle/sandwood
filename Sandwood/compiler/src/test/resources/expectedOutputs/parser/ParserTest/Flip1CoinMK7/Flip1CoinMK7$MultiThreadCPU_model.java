...
import org.sandwood.compiler.tests.parser.Flip1CoinMK7$MultiThreadCPU.Scratch;
import org.sandwood.compiler.tests.parser.Flip1CoinMK7.State;
...
final class Flip1CoinMK7$MultiThreadCPU extends CoreModelMultiThreadCPU<State, Scratch> {
	...
	public Flip1CoinMK7$MultiThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
