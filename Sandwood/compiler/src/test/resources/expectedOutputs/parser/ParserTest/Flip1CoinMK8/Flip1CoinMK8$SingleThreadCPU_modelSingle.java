...
class Flip1CoinMK8$SingleThreadCPU extends org.sandwood.runtime.internal.model.CoreModelSingleThreadCPU implements Flip1CoinMK8$CoreInterface {
	...
	public Flip1CoinMK8$SingleThreadCPU(ExecutionTarget target) {
		super(target);
	}
