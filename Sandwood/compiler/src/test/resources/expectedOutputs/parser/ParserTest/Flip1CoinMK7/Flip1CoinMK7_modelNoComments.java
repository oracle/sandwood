...
/**
 * Class representing the Sandwood model Flip1CoinMK7 This is the class that all user
 * interactions with the model should occur through.
 */
public final class Flip1CoinMK7 extends Model {
    private Flip1CoinMK7$CoreInterface system$c = new Flip1CoinMK7$SingleThreadCPU(ExecutionTarget.singleThread);
	 ...
	 */
    public Flip1CoinMK7(int flipsMeasuredShape) {
        this();
	 ...
	 */
    public Flip1CoinMK7(boolean[] flipsMeasured) {
        this();
        this.flipsMeasured.setValue(flipsMeasured);
    }
    
    @Override
    protected Flip1CoinMK7$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        Flip1CoinMK7$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new Flip1CoinMK7$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new Flip1CoinMK7$MultiThreadCPU(target);
                break;
            default:
    ...
    private void transferData(Flip1CoinMK7$CoreInterface oldCore, Flip1CoinMK7$CoreInterface newCore) {
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(Flip1CoinMK7 system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(Flip1CoinMK7 system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(Flip1CoinMK7 system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(Flip1CoinMK7 system$model) {
