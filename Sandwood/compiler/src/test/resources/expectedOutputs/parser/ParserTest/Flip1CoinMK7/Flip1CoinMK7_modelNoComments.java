 ...
 */
public final class Flip1CoinMK7 extends Model<Flip1CoinMK7.State> {
...
double bias;
    ...
    public Flip1CoinMK7() {
        ...
        Flip1CoinMK7$SingleThreadCPU core = new Flip1CoinMK7$SingleThreadCPU(state, ExecutionTarget.singleThread);
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new Flip1CoinMK7$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new Flip1CoinMK7$MultiThreadCPU(state, target);
            default:
