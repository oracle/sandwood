...
/**
 * Class representing the Sandwood model Flip2CoinsMK3 This is the class that all
 * user interactions with the model should occur through.
 */
public final class Flip2CoinsMK3 extends Model<Flip2CoinsMK3.State> {
...
double a;
    ...
    public Flip2CoinsMK3() {
        ...
        Flip2CoinsMK3$SingleThreadCPU core = new Flip2CoinsMK3$SingleThreadCPU(state, ExecutionTarget.singleThread);
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new Flip2CoinsMK3$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new Flip2CoinsMK3$MultiThreadCPU(state, target);
            default:
