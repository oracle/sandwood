...
import org.sandwood.compiler.tests.parser.HMMTestPart1b$MultiThreadCPU.Scratch;
...
final class HMMTestPart1b$MultiThreadCPU extends CoreModelMultiThreadCPU<State, Scratch> {
	...
	public HMMTestPart1b$MultiThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
