...
public class HMMTestPart3c extends GeneratedAPIBuilder {
    @Override
    public CompilationDesc buildClass(CompilationOptions opts) {
        ...
        parFor(intVariable(1, location(26, 20, 26, 20)), samples, intVariable(1, location(26, 19, 26, 22)), true, location(26, 9, 26, 31), (i) -> { 
            ...
            st.put((i.add(i, location(27, 18, 27, 18))).divide(intVariable(2, location(27, 22, 27, 22)), location(27, 21, 27, 21)), categorical(m.get(st.get(i.subtract(intVariable(1, location(27, 46, 27, 46)), location(27, 45, 27, 45)), location(27, 43, 27, 47)), location(27, 40, 27, 48)), location(27, 27, 27, 49)).sample(location(27, 51, 27, 58)), location(27, 15, 27, 58));
        });
        ...
        return compileAPI(opts, $variableNames, "HMMTestPart3c", $helperClasses, "org.sandwood.compiler.tests.parser", $constructorArgs, getOriginalModel(), null);
    }
