		...
		if(true) {
			...
			for(int cv$valuePos = 0; cv$valuePos < cv$numNumStates; cv$valuePos += 1) {
				...
				}
				{
					...
					double cv$accumulatedProbabilities = (Math.log(1.0) + (((0.0 <= cv$currentValue) && (cv$currentValue < cv$temp$1$$var324))?Math.log(cv$temp$0$var50[cv$currentValue]):Double.NEGATIVE_INFINITY));
												...
												{
													{
														...
														int cv$temp$3$$var333;
														{
															// Constructing a random variable input for use later.
															int $var333 = states;
															cv$temp$3$$var333 = $var333;
														}
														
														// Record the probability of sample task 72 generating output with current configuration.
														if(((Math.log(1.0) + (((0.0 <= st[i$var65]) && (st[i$var65] < cv$temp$3$$var333))?Math.log(cv$temp$2$var69[st[i$var65]]):Double.NEGATIVE_INFINITY)) < cv$accumulatedConsumerProbabilities))
															cv$accumulatedConsumerProbabilities = (Math.log((Math.exp(((Math.log(1.0) + (((0.0 <= st[i$var65]) && (st[i$var65] < cv$temp$3$$var333))?Math.log(cv$temp$2$var69[st[i$var65]]):Double.NEGATIVE_INFINITY)) - cv$accumulatedConsumerProbabilities)) + 1)) + cv$accumulatedConsumerProbabilities);
														else {
															// If the second value is -infinity.
															if((cv$accumulatedConsumerProbabilities == Double.NEGATIVE_INFINITY))
																cv$accumulatedConsumerProbabilities = (Math.log(1.0) + (((0.0 <= st[i$var65]) && (st[i$var65] < cv$temp$3$$var333))?Math.log(cv$temp$2$var69[st[i$var65]]):Double.NEGATIVE_INFINITY));
															else
																cv$accumulatedConsumerProbabilities = (Math.log((Math.exp((cv$accumulatedConsumerProbabilities - (Math.log(1.0) + (((0.0 <= st[i$var65]) && (st[i$var65] < cv$temp$3$$var333))?Math.log(cv$temp$2$var69[st[i$var65]]):Double.NEGATIVE_INFINITY)))) + 1)) + (Math.log(1.0) + (((0.0 <= st[i$var65]) && (st[i$var65] < cv$temp$3$$var333))?Math.log(cv$temp$2$var69[st[i$var65]]):Double.NEGATIVE_INFINITY)));
														}
		...
		if(true) {
			...
			for(int cv$valuePos = 0; cv$valuePos < cv$numNumStates; cv$valuePos += 1) {
				...
				}
				{
					...
					int cv$temp$1$$var355;
					{
						// Constructing a random variable input for use later.
						int $var355 = states;
						cv$temp$1$$var355 = $var355;
					}
					
					// An accumulator to allow the value for each distribution to be constructed before
					// it is added to the index probabilities.
					double cv$accumulatedProbabilities = (Math.log(1.0) + (((0.0 <= cv$currentValue) && (cv$currentValue < cv$temp$1$$var355))?Math.log(cv$temp$0$var69[cv$currentValue]):Double.NEGATIVE_INFINITY));
												...
												{
													{
														...
														int cv$temp$3$$var364;
														{
															// Constructing a random variable input for use later.
															int $var364 = states;
															cv$temp$3$$var364 = $var364;
														}
														
														// Record the probability of sample task 72 generating output with current configuration.
														if(((Math.log(1.0) + (((0.0 <= st[index$i$2_2]) && (st[index$i$2_2] < cv$temp$3$$var364))?Math.log(cv$temp$2$var69[st[index$i$2_2]]):Double.NEGATIVE_INFINITY)) < cv$accumulatedConsumerProbabilities))
															cv$accumulatedConsumerProbabilities = (Math.log((Math.exp(((Math.log(1.0) + (((0.0 <= st[index$i$2_2]) && (st[index$i$2_2] < cv$temp$3$$var364))?Math.log(cv$temp$2$var69[st[index$i$2_2]]):Double.NEGATIVE_INFINITY)) - cv$accumulatedConsumerProbabilities)) + 1)) + cv$accumulatedConsumerProbabilities);
														else {
															// If the second value is -infinity.
															if((cv$accumulatedConsumerProbabilities == Double.NEGATIVE_INFINITY))
																cv$accumulatedConsumerProbabilities = (Math.log(1.0) + (((0.0 <= st[index$i$2_2]) && (st[index$i$2_2] < cv$temp$3$$var364))?Math.log(cv$temp$2$var69[st[index$i$2_2]]):Double.NEGATIVE_INFINITY));
															else
																cv$accumulatedConsumerProbabilities = (Math.log((Math.exp((cv$accumulatedConsumerProbabilities - (Math.log(1.0) + (((0.0 <= st[index$i$2_2]) && (st[index$i$2_2] < cv$temp$3$$var364))?Math.log(cv$temp$2$var69[st[index$i$2_2]]):Double.NEGATIVE_INFINITY)))) + 1)) + (Math.log(1.0) + (((0.0 <= st[index$i$2_2]) && (st[index$i$2_2] < cv$temp$3$$var364))?Math.log(cv$temp$2$var69[st[index$i$2_2]]):Double.NEGATIVE_INFINITY)));
														}
