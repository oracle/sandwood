...
public class ParallelMK5 extends GeneratedAPIBuilder {
    @Override
    public CompilationDesc buildClass(CompilationOptions opts) {
        ...
        ArrayVariable<ArrayVariable<DoubleVariable>> indirection1 = Variable.arrayVariable(location(13, 41, 13, 61), VariableType.arrayType(VariableType.DoubleVariable), intVariable(10, location(13, 42, 13, 43)), observed.length(location(13, 55, 13, 60)));
        ...
        parFor(intVariable(0, location(16, 15, 16, 15)), intVariable(10, location(16, 20, 16, 21)), intVariable(1, location(16, 24, 16, 26)), true, location(16, 5, 16, 27), (i) -> { 
            i.setAlias("i");
            i.setLocation(location(16, 13, 16, 13));
            parFor(intVariable(0, location(17, 19, 17, 19)), observed.length(location(17, 33, 17, 38)), intVariable(1, location(17, 41, 17, 43)), true, location(17, 9, 17, 44), (j) -> { 
                j.setAlias("j");
        ...
        parFor(intVariable(0, location(22, 15, 22, 15)), observed.length(location(22, 29, 22, 34)), intVariable(1, location(22, 37, 22, 39)), true, location(22, 5, 22, 40), (k) -> { 
            ...
            parFor(intVariable(0, location(23, 19, 23, 19)), intVariable(10, location(23, 24, 23, 25)), intVariable(1, location(23, 28, 23, 30)), true, location(23, 9, 23, 31), (l) -> { 
                ...
                indirection2.get(k, location(24, 25, 24, 27)).put(l, indirection1.get(l, location(24, 46, 24, 48)).get(k, location(24, 49, 24, 51)), location(24, 28, 24, 51));
        ...
        return compileAPI(opts, $variableNames, "ParallelMK5", $helperClasses, "org.sandwood.compiler.tests.parser", $constructorArgs, getOriginalModel(), null);
    }
