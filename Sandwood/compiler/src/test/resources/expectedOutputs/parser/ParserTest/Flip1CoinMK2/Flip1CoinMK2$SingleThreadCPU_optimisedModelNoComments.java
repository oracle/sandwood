...
import org.sandwood.compiler.tests.parser.Flip1CoinMK2$SingleThreadCPU.Scratch;
...
final class Flip1CoinMK2$SingleThreadCPU extends CoreModelSingleThreadCPU<State, Scratch> {
	...
	public Flip1CoinMK2$SingleThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
