...
public class Conditional1 extends GeneratedAPIBuilder {
    @Override
    public CompilationDesc buildClass(CompilationOptions opts) {
        ...
        DoubleVariable value = ifElseLambdaAssignment(guard, () -> { return doubleVariable(1.0, location(19, 26, 19, 28)); }, () -> { return uniform(doubleVariable(0.0, location(19, 38, 19, 40)), doubleVariable(1.0, location(19, 43, 19, 45)), location(19, 30, 19, 46)).sample(location(19, 48, 19, 55)); }, location(19, 20, 19, 55));
        value.setAlias("value");
        value.setLocation(location(19, 12, 19, 16));

        value.observe(observedValue, location(22, 11, 22, 32));

        Variable<?>[] $variableNames = {observedValue, bernoulli, guard, value};
        String[] $constructorArgs = {"observedValue"};
        Set<String> $helperClasses = new HashSet<>();
        return compileAPI(opts, $variableNames, "Conditional1", $helperClasses, "org.sandwood.compiler.tests.parser", $constructorArgs, getOriginalModel(), null);
    }
