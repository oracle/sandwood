...
/**
  * Class representing the Sandwood model Flip2CoinsMK2 This is the class that
  * all user interactions with the model should occur through.
  */
public final class Flip2CoinsMK2 extends Model {

    private Flip2CoinsMK2$CoreInterface system$c = new Flip2CoinsMK2$SingleThreadCPU(ExecutionTarget.singleThread);
    ...
    private final IteratedRandomVariableInternal<double[][]> $bernoulli = new IteratedRandomVariableInternal<double[][]>(this, "bernoulli", 2, ProbabilityType.SKIPPABLE) {
        @Override
     ...
     * the Sandwood model. The random variable is embedded in 2 loops
     * so results are returned as a 2dimensional array.
     */
    ...
    public Flip2CoinsMK2(double a, double b, int[] flipsMeasuredShape) {
        this();
        this.$a.setValue(a);
        this.$b.setValue(b);
    ...
    public Flip2CoinsMK2(double a, double b, boolean[][] flipsMeasured) {
        this();
        this.a.setValue(a);
        this.b.setValue(b);
    ...
    @Override
    protected Flip2CoinsMK2$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        Flip2CoinsMK2$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new Flip2CoinsMK2$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new Flip2CoinsMK2$MultiThreadCPU(target);
                break;
            default:
    ...
    private void transferData(Flip2CoinsMK2$CoreInterface oldCore, Flip2CoinsMK2$CoreInterface newCore) {
        //Model inputs
        if(a.isSet())
    ...
    public static class InferredValueOutputs {
        ...
        InferredValueOutputs(Flip2CoinsMK2 system$model) {
    ...
    public static class LogProbabilities {
        ...
        LogProbabilities(Flip2CoinsMK2 system$model) {
    ...
    public static class Probabilities {
        ...
        Probabilities(Flip2CoinsMK2 system$model) {
    ...
    public static class InferredModelOutputs {
        ...
        InferredModelOutputs(Flip2CoinsMK2 system$model) {
