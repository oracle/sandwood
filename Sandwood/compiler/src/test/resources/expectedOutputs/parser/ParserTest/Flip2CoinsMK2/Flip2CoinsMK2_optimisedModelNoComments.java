...
/**
  ...
  */
public class Flip2CoinsMK2 extends Model {
    ...
    private final IteratedRandomVariableInternal<double[][]> $bernoulli = new IteratedRandomVariableInternal<double[][]>(this, "bernoulli", 2) {
        @Override
