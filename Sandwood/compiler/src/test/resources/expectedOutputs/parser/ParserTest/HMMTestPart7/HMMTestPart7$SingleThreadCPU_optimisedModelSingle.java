	...
	private final void sample31(int var29) {
			...
			if((1 < samples)) {
				if(fixedFlag$sample57) {
					...
					if((var29 < 5))
						...
						cv$var30$countGlobal[st[1]] = (cv$var30$countGlobal[st[1]] + distribution$sample57[var29]);
				}
			}
		...
		if(((var29 == 0) && !fixedFlag$sample57)) {
			...
			for(int cv$loopIndex = 0; cv$loopIndex < 5; cv$loopIndex += 1)
				...
				cv$var30$countGlobal[cv$loopIndex] = (cv$var30$countGlobal[cv$loopIndex] + distribution$sample57[cv$loopIndex]);
		}
			...
			if((1 < samples)) {
				if(fixedFlag$sample57) {
					...
					if((var29 < 5)) {
						...
						for(int cv$loopIndex = 0; cv$loopIndex < 5; cv$loopIndex += 1)
							// A local reference to the scratch space.
							cv$var30$countGlobal[cv$loopIndex] = (cv$var30$countGlobal[cv$loopIndex] + (distribution$sample75[0][cv$loopIndex] * cv$distributionProbability));
					}
				}
			}
