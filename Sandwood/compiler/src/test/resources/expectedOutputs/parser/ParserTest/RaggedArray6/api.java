...
public class RaggedArray6 extends GeneratedAPIBuilder {
    @Override
    public CompilationDesc buildClass(CompilationOptions opts) {
        ...
        ArrayVariable<BooleanVariable> obs = bernoulli(d.get(y, location(16, 32, 16, 34)), location(16, 21, 16, 35)).sample(obs_measured.length(location(16, 57, 16, 62)), location(16, 37, 16, 63));
        obs.setAlias("obs");
        obs.setLocation(location(16, 15, 16, 17));
        ...
        return compileAPI(opts, $variableNames, "RaggedArray6", $helperClasses, "org.sandwood.compiler.tests.parser", $constructorArgs, getOriginalModel(), null);
    }
