 ...
 */
public final class DistributionTest3 extends Model<DistributionTest3.State> {
...
boolean constrainedFlag$sample4 = true;
    ...
    public DistributionTest3() {
        ...
        DistributionTest3$SingleThreadCPU core = new DistributionTest3$SingleThreadCPU(state, ExecutionTarget.singleThread);
    ...
    protected CoreModelBase<State,?> setExecutionTargetInternal(ExecutionTarget target) {
        switch(target.executionType) {
            case SingleThreadCPU:
                return new DistributionTest3$SingleThreadCPU(state, target);
            case MultiThreadCPU:
                return new DistributionTest3$MultiThreadCPU(state, target);
            default:
