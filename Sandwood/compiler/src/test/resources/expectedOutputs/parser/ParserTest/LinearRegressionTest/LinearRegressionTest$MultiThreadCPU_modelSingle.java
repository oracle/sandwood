													...
													{
														{
															...
															if((0 < k)) {
																...
																for(int cv$reduction381Index = 0; cv$reduction381Index < j$var62; cv$reduction381Index += 1) {
																	// Set the left hand term of the reduction function to the return variable value.
																	double i$var74 = reduceVar$var77$5;
																	
																	// Set the right hand term to a value from the array phi
																	double j$var75 = phi[((i$var52 - 0) / 1)][cv$reduction381Index];
																...
																for(int cv$reduction381Index = (j$var62 + 1); cv$reduction381Index < k; cv$reduction381Index += 1) {
																	// Set the left hand term of the reduction function to the return variable value.
																	double i$var74 = reduceVar$var77$5;
