														...
														{
															{
																...
																if((0 < k)) {
																	...
																	for(int cv$reduction359Index = 0; cv$reduction359Index < j$var55; cv$reduction359Index += 1) {
																		// Set the left hand term of the reduction function to the return variable value.
																		double i$var67 = reduceVar$var70$6;
																		
																		// Set the right hand term to a value from the array phi
																		double j$var68 = phi[((i$var45 - 0) / 1)][cv$reduction359Index];
																	...
																	for(int cv$reduction359Index = (j$var55 + 1); cv$reduction359Index < k; cv$reduction359Index += 1) {
																		// Set the left hand term of the reduction function to the return variable value.
																		double i$var67 = reduceVar$var70$6;
