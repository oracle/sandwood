...
class Flip1CoinArrayCopyPass$MultiThreadCPU extends org.sandwood.runtime.internal.model.CoreModelMultiThreadCPU implements Flip1CoinArrayCopyPass$CoreInterface {
	...
	private final void logProbabilityValue$sample29() {
		...
		if(!fixedProbFlag$sample29) {
			...
			for(int i = 0; i < samples; i += 1) {
				...
				// Store the sample task probability
				logProbability$sample29[i] = cv$distributionAccumulator;
			}
		...
		// Using cached values.
			...
			for(int i = 0; i < samples; i += 1) {
				...
				double cv$rvAccumulator = logProbability$sample29[i];
	...
	public final void allocator() {
		...
		logProbability$sample29 = new double[samples];
	}
