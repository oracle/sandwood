...
import org.sandwood.compiler.tests.parser.Flip1CoinArrayCopyPass$MultiThreadCPU.Scratch;
...
final class Flip1CoinArrayCopyPass$MultiThreadCPU extends CoreModelMultiThreadCPU<State, Scratch> {
	...
	public Flip1CoinArrayCopyPass$MultiThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
