...
import org.sandwood.compiler.tests.parser.Conditional2e$SingleThreadCPU.Scratch;
import org.sandwood.compiler.tests.parser.Conditional2e.State;
import org.sandwood.runtime.internal.model.CoreModelSingleThreadCPU;
import org.sandwood.runtime.internal.model.state.CoreModelScratch;
import org.sandwood.runtime.internal.numericTools.DistributionSampling;
import org.sandwood.runtime.model.ExecutionTarget;

final class Conditional2e$SingleThreadCPU extends CoreModelSingleThreadCPU<State, Scratch> {
...
double[] cv$var4$stateProbabilityGlobal;
	...
	public Conditional2e$SingleThreadCPU(State state, ExecutionTarget target) {
		super(state, target);
		scratch = new Scratch();
	}
	...
	private final void logProbabilityValue$sample8() {
		if(!state.fixedProbFlag$sample8) {
			...
			if(!state.guard) {
				...
				state.logProbability$v = (state.logProbability$v + state.logProbability$sample8);
			}
