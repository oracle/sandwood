...
final class Flip1CoinMK1b$MultiThreadCPU extends org.sandwood.runtime.internal.model.CoreModelMultiThreadCPU implements Flip1CoinMK1b$CoreInterface {
	...
	private final void logProbabilityValue$sample6() {
		...
		if(!fixedProbFlag$sample6) {
			...
			// 
			// The sample value to calculate the probability of generating
			double cv$distributionAccumulator = DistributionSampling.logProbabilityBeta(bias, a, b);
