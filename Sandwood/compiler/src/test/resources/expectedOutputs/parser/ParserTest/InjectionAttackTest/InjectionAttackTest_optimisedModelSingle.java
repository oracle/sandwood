...
/** a bias to see how like values are to be collected. " + new java.util.Random().nextDouble() + "*/
    ...
    @Override
    protected InjectionAttackTest$CoreInterface setExecutionTargetInternal(ExecutionTarget target) {
        InjectionAttackTest$CoreInterface newCore;
        switch(target.executionType) {
            case SingleThreadCPU:
                newCore = new InjectionAttackTest$SingleThreadCPU(target);
                break;
            case MultiThreadCPU:
                newCore = new InjectionAttackTest$MultiThreadCPU(target);
                break;
            default:
