...
public class LogisticRegressionTest extends GeneratedAPIBuilder {
    @Override
    public CompilationDesc buildClass(CompilationOptions opts) {
        //Allocating initial observed parameters
        ArrayVariable<ArrayVariable<DoubleVariable>> x = observeArray("x", VariableType.arrayType(VariableType.arrayType(VariableType.DoubleVariable)), location(13, 30, 13, 41));
        ArrayVariable<BooleanVariable> yMeasured = observeArray("yMeasured", VariableType.arrayType(VariableType.BooleanVariable), location(13, 44, 13, 62));
        ...
        parFor(intVariable(0, location(22, 16, 22, 16)), n, intVariable(1, location(22, 15, 22, 18)), true, location(22, 5, 22, 21), (i) -> { 
            ...
            y.put(i, bernoulli(success, location(27, 16, 27, 33)).sample(location(27, 35, 27, 42)), location(27, 10, 27, 42));
