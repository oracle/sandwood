...
class Flip1CoinMK2b$SingleThreadCPU extends org.sandwood.runtime.internal.model.CoreModelSingleThreadCPU implements Flip1CoinMK2b$CoreInterface {
	...
	private final void logProbabilityValue$sample16() {
		...
		if(!fixedProbFlag$sample16) {
			...
			for(int i=0; i<samples; i+=1)
				...
				calculationVariable$sampleAccumulator = (calculationVariable$sampleAccumulator + DistributionSampling.logProbabilityBernoulli(flipsMeasured[i], bias));
	...
	private final void logProbabilityValue$sample8() {
		...
		if(!fixedProbFlag$sample8) {
			...
			// 
			// Accumulator for sample probabilities for a specific instance of the random variable.
			logProbability$var6 = calculationVariable$distributionAccumulator;
	...
	// by sample task 8 drawn from Beta 6. Inference was performed using a Beta to Bernoulli/Binomial
	// conjugate prior.
