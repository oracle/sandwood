...
class AlternativeModelMK3$MultiThreadCPU extends org.sandwood.runtime.internal.model.CoreModelMultiThreadCPU implements AlternativeModelMK3$CoreInterface {
	...
	public final void set$fixedFlag$sample6(boolean calculationVariable$value) {
		...
		// 
		// Substituted "fixedFlag$sample6" with its value "calculationVariable$value".
		fixedProbFlag$sample8 = (calculationVariable$value && fixedProbFlag$sample8);
	}
	...
	@Override
	public final void set$fixedFlag$sample8(boolean calculationVariable$value) {
		// Set flags for all the side effects of fixedFlag$sample8 including if probabilities
		// need to be updated.
		fixedFlag$sample8 = calculationVariable$value;
		
		// Should the probability of sample 8 be set to fixed. This will only every change
		// the flag to false.
		// 
		// Substituted "fixedFlag$sample8" with its value "calculationVariable$value".
		fixedProbFlag$sample8 = (calculationVariable$value && fixedProbFlag$sample8);
	}
	...
	private final void sample6() {
		...
		bias = Conjugates.sampleConjugateBetaBinomial(RNG$, 1.0, 1.0, observedPositiveCount, observedSampleCount);
	}
