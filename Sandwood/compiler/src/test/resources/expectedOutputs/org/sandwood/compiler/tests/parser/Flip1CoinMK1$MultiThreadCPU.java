...
class Flip1CoinMK1$MultiThreadCPU extends org.sandwood.runtime.internal.model.CoreModelMultiThreadCPU implements Flip1CoinMK1$CoreInterface {
	...
	@Override
	public final void set$fixedFlag$sample9(boolean calculationVariable$value) {
		// Set flags for all the side effects of fixedFlag$sample9 including if probabilities
		// need to be updated.
		fixedFlag$sample9 = calculationVariable$value;
		
		// Should the probability of sample 9 be set to fixed. This will only every change
		// the flag to false.
		// 
		// Substituted "fixedFlag$sample9" with its value "calculationVariable$value".
		fixedProbFlag$sample9 = (calculationVariable$value && fixedProbFlag$sample9);
	...
	// Setter for samples.
	@Override
	public final void set$samples(int calculationVariable$value) {
		samples = calculationVariable$value;
	}
