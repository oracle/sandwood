...
class HMMTestPart2$MultiThreadCPU extends org.sandwood.runtime.internal.model.CoreModelMultiThreadCPU implements HMMTestPart2$CoreInterface {
	...
	private final void sample17(int var15, int threadID$calculationVariable$var15, Rng RNG$) {
		...
		// Substituted "calculationVariable$indexState$var229" with its value "0".
		calculationVariable$CountLocal[0] = 0.0;
		
		// Substituted "calculationVariable$indexState$var229" with its value "1".
		...
		for(int i$var35=1; i$var35<samples; i$var35+=1) {
			if((var15 == st[(i$var35 - 1)]))
				...
				// variable var40
				calculationVariable$CountLocal[st[i$var35]] = (calculationVariable$CountLocal[st[i$var35]] + 1.0);
		}
