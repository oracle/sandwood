...
class HMMTestPart3b$MultiThreadCPU extends org.sandwood.runtime.internal.model.CoreModelMultiThreadCPU implements HMMTestPart3b$CoreInterface {
	...
	private final void sample17(int var15, int threadID$calculationVariable$var15, Rng RNG$) {
		...
		// Substituted "calculationVariable$indexState$var276" with its value "0".
		calculationVariable$CountLocal[0] = 0.0;
		
		// Substituted "calculationVariable$indexState$var276" with its value "1".
		...
		for(int i$var39=4; i$var39<(samples + 3); i$var39+=1) {
			if((var15 == st[(i$var39 - 4)]))
				...
				// variable var46
				calculationVariable$CountLocal[st[(i$var39 - 3)]] = (calculationVariable$CountLocal[st[(i$var39 - 3)]] + 1.0);
		}
