...
class Flip2CoinsMK3$MultiThreadCPU extends org.sandwood.runtime.internal.model.CoreModelMultiThreadCPU implements Flip2CoinsMK3$CoreInterface {
	...
	private final void logProbabilityValue$sample16() {
		...
		if(!fixedProbFlag$sample16) {
			...
			for(int var13=0; var13<coins; var13+=1)
				...
				calculationVariable$sampleAccumulator = (calculationVariable$sampleAccumulator + DistributionSampling.logProbabilityBeta(bias[var13], a, b));
	...
	private final void sample16(int var13, int threadID$calculationVariable$var13, Rng RNG$) {
		...
		bias[var13] = Conjugates.sampleConjugateBetaBinomial(RNG$, a, b, calculationVariable$Sum, calculationVariable$Count);
	}
