...
public class Flip1CoinMK4 extends ModelTestSkeleton {
    ...
    public Flip1CoinMK4() throws SandwoodJsonException, IOException {
        super();
    }
    ...
    protected CompilationDesc buildClass(CompilationOptions opts) {
        ...
        b.setAlias("b");
        // TODO Rap this in a static method in Array variable as syntactic sugar.
