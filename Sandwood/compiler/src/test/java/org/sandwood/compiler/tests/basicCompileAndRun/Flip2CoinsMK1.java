...
public class Flip2CoinsMK1 extends ModelTestSkeleton {
     ...
     * <- 1 to K) { for(j <- 1 to N) { Bernoulli(bias(j)).sample() } }
     *
     * observe(flips) } }
     */

    public Flip2CoinsMK1() throws SandwoodJsonException, IOException {
        super();
    }
    ...
    protected void initializeClass(Class<?> cls, Object o)
        ...
        boolean[] list1 = new boolean[noFlips];
