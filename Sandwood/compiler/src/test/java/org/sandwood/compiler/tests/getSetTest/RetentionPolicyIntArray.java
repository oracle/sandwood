...
public class RetentionPolicyIntArray extends ModelTestSkeleton {
    ...
    protected CompilationDesc buildClass(CompilationOptions opts) {
        ...
        b.setAlias("b");
        IntVariable bias = beta(a, b).sample().castToInteger();
        bias.setAlias("bias");
        ArrayVariable<IntVariable> array = arrayVariable(VariableType.IntVariable, 1);
        array.put(0, bias);
        array.setAlias("array");
        Bernoulli bernoulli = bernoulli(array.get(0).castToDouble());
