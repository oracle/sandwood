...
public class RetentionPolicyDoubleArray extends ModelTestSkeleton {
    ...
    protected CompilationDesc buildClass(CompilationOptions opts) {
        ...
        b.setAlias("b");
        ArrayVariable<DoubleVariable> bias = beta(a, b).sample(1);
        bias.setAlias("bias");
        Bernoulli bernoulli = bernoulli(bias.get(0));
