    ...
    static {
        ...
        }
        {
            ...
            String annotatedMessage = "General Error\n" + "Model LinearRegression2Fail should be in the directory:\n"
                    + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "testInputs"
                    + File.separator + ", not:\n" + "src" + File.separator + "test" + File.separator + "resources"
                    + File.separator + "testInputs" + File.separator + "org" + File.separator + "sandwood"
                    + File.separator + "compiler" + File.separator + "tests" + File.separator + "parser";
